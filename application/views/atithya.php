  ...
  <nav id="navArea">
      <div class="logo">
        <a href="https://digitalki.com.au/encalm/">
          ...
          <img src="image/Encalm-Logo-Primary.png" alt="encalm" id="blue_logo" class="img-fluid">
        </a>
      </div>
      <div class="hamburger">
            ...
            <ul class="subMenu">
              ...
              <li><a href="#">Our Brands &nbsp;<i class="fa fa-angle-right"></i></a>
                <ul class="subMenu">
                  ...
                  <li><a href="https://digitalki.com.au/encalm/encalm_lounge.php">Encalm Lounge</a></li>
                  <!--<li><a href="https://digitalki.com.au/encalm/encalm_spa.php">Encalm Spa</a></li>-->
                  <!--<li><a href="https://digitalki.com.au/encalm/encalm_hotel.php">Encalm Hotels</a></li>-->
                </ul>
              </li>
              ...
              <li><a href="https://digitalki.com.au/encalm/gallery.php">Gallery</a></li>
            </ul>
          </li>
          <li><a href="#">Services <i class="fa fa-angle-down"></i></a>
            <ul class="subMenu">
              <li><a href="https://digitalki.com.au/encalm/encalm_lounge.php">Lounge</a></li>
              <li><a href="https://digitalki.com.au/encalm/atithya.php">Welcome and Assist</a></li>
              <!--<li><a href="#">SPA</a></li>-->
              <!--<li><a href="#">Hotels</a></li>-->
            </ul>
          </li>
          
          <li><a href="#contact-section" class="nav-link text-white"><i class="fa fa-user-circle-o" aria-hidden="true"></i> Login</a>
            <ul class="subMenu">
...
<section>
      ...
      <div class="row">
        <div class="col-lg-12  pt-lg-0 content">
          <div class="section-title text-center">
            <!--<h2>About</h2>-->
            <p class="mr-top-136"><img src="image/atithya/Atithya-Logo-Golden.jpg" alt="Lounge Service" title="Lounge Service" style="width: 150px;"></p>
          </div>
    <!--           <div class="row">-->
    <!--  <div class="col-lg-12">-->
    <!--    <div class="section-title text-center">-->
    ...
    <!--  </div>-->
    <!--</div>-->
          <p class="text-center text-secondary mt-4">Atithya, with a concept of Atithi Devo Bhava (Guest is of supreme importance and is treated as God) is a bespoke Welcome & Assist service presented by Encalm Hospitality Pvt. Ltd. With a mission to make airport travel a unique experience in itself, all the services have been carved to make journey through airport a luxurious service cruising through the chaotic on ground situation inside the airport. 
We are dedicated to deliver the perfect tailor-made airport experience for each for our guest whether on arrival, departure, or transit. From baggage handling, lounge stays, airport assistance to buggy service, we guarantee smooth coordination at every point in the airport.</p>
        </div>
      </div>
    </div>
</section>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
             <div class="section-title text-center">
              <!-- <h2>Our</h2> -->
              <p>Atithya Services</p>
            </div> 
            
          </div>
          
            <div class="icon-serve">
                          <div class="box-icon text-center"><img src="image/atithya/Airport-assistance.png" alt="Encalm"/> <p class="color-main text-center">Airport Assistance</p></div>
                          <div class="box-icon text-center"><img src="image/atithya/Buggy.png" alt="Encalm"/> <p class="color-main text-center">Buggy</p></div>
                          <div class="box-icon text-center"><img src="image/atithya/Concierge-Services.png" alt="Encalm"/> <p class="color-main text-center">Concierge Services</p></div>
                          <div class="box-icon text-center"><img src="image/atithya/Greeting-services.png" alt="Encalm"/> <p class="color-main text-center">Greeting Services</p></div>
                          <div class="box-icon text-center"><img src="image/atithya/Porter.png" alt="Encalm"/> <p class="color-main text-center">Porter</p></div>
                          <div class="box-icon text-center"><img src="image/atithya/Wheel-Chair.png" alt="Encalm"/> <p class="color-main text-center">Wheel Chair</p></div>
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="border-left">
                  ...
                  <p class="text-center color-black"><i class="fa fa-map-marker" aria-hidden="true"></i> T1/T2/T3, IGI Airport, New Delhi -110037</p>
                  <p class="text-center color-black"><i class="fa fa-envelope color-blue" aria-hidden="true"></i> guest.services@encalm.com </p>
                  <p class="text-center color-black"><i class="fa fa-phone color-blue" aria-hidden="true"></i> +91-9289366950</p>
              </div>
          </div>
          <div class="col-lg-6">
          ...
          <div class="col-lg-12">
              <div class="brand-carousel-1 section-padding owl-carousel">
                <div class="single-logo testi text-center">
                 ...
                 <h3>Very staff and food</h3>
                  <p class="color-black"><sup>"</sup>I am traveling to delhi airport and i like to say this lounge is very good and in food and ambiance wise i really like to mention few name rohit jha.thanks to rohit jha for his wonderful service.<sup>"</sup></p>
                 <h6 class="color-blue">Irshad</h6>
               ...
               <div class="single-logo testi text-center">
                 ...
                 <h3>Great environment, and good food.</h3>
                  <p class="color-black"><sup>"</sup>I stayed at the lounge for an hour or so before my flight. It has good ambience, and is less crowded. I tried Paw Bhaji from the breakfast menu, which was delicious. The place is kept clean and hygienic. Manohar and Vikas here were very helpful, and took good care of customers and the place.
                    <br/>One drawback is that not all cards are supported at the moment. Thankfully I had one of the supported cards.<sup>"</sup></p>
                 <h6 class="color-blue">Shubham Kumaram</h6>
                  <p class="color-black mb-2"><strong>Date of visit:</strong> March 2022</p>
                ...
                <div class="single-logo testi text-center">
                 ...
                 <h3>Awesome experience</h3>
                  <p class="color-black"><sup>"</sup>Superb experience, lounge was neat and clean, much better than premium plaza, special thanks to Aman Tomar for showing covid appropriate behaviour and helping me with extra mask, he was also help other guests for their needs and maintaining covid protocols.<sup>"</sup></p>
                 <h6 class="color-blue">Saurabh</h6>
                  <p class="color-black mb-2"><strong>Date of visit:</strong> March 2022</p>

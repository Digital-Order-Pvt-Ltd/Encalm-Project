<?php
$meta_title = 'Gallery   | Encalm Hospitality';
$meta_description = 'Check out the latest pictures from our gallery.';
$meta_website_description = 'Check out the latest pictures from our gallery.';

include('header.php'); ?>
<!-- Go to www.addthis.com/dashboard to customize your tools --> <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-627e1efe4bc6c65d"></script>
...
.flip-card-back h2{color:#152248!important; font-family:Brandon!important; font-weight:600!important;}
  ...
  /*-------------------------Location----------------------------------*/
    ...
    .bor-bot{ padding-top:8px;}
    .icon-serve img{width:80px; border: 1px solid #dedede;}
    .icon-serve{position: relative; bottom:0px;}
    .f-22{font-size:20px;}
    ...
    .share-icon p{margin-bottom:0px; text-align: center; color: #ffffff!important;}
    .share-icon p span{color;#ffffff!important;}
    .share-icon p a{color;#ffffff!important;}
  /*----------------------End Location--------------------------------*/
  /*--------------------logo------------------------------*/
  ...
  .section-padding{
    ...
    .thumb img{border: 1px solid #dedede; padding:10;}
...
@media screen and (min-width: 937px) and (max-width: 1000px){
    ...
    @media screen and (min-width: 320px) and (max-width: 480px){
        ...
        .mr-t-160 {margin-top: 120px!important;}
        #navArea{height:90px;}
      .box-image {width: 160px;}
      .box-location h3{margin-top:15px; text-align: center;}
      .box-location h5{text-align:center;}
    ...
    <div class="container">
      ...
      <div class="col-lg-12">
        <div class="section-title text-center">
            <!--<h2>About</h2>-->
            <p class="mb-5 mr-t-160">Encalm Gallery</p>
          </div>
      </div>
    </div>
      <div class="row ml-0 mr-0  mb-5">
            ...
            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                <a href="<?=base_url()?>assets/image/gallery/gallery_1.jpg" class="fancybox" rel="ligthbox">
                    <img src="<?=base_url()?>assets/image/gallery/gallery_thumb_1.jpg" class="zoom img-fluid"  alt="Atithya services, Welcome and Assist, Meet and Greet, Delhi Airport">
                   
                </a>
                <div class="share-icon">
                    <p><span><a href="#" data-bs-toggle="modal" data-bs-target="#shareicons"><i class="fa fa-share-alt" aria-hidden="true"></i></a> </span> <!----<a herf="#"><i class="fa fa-facebook-square" aria-hidden="true"></i></a> <a herf="#"><i class="fa fa-twitter-square" aria-hidden="true"></i></a> <a herf="#"><i class="fa fa-instagram" aria-hidden="true"></i></a> <a herf="#"><i class="fa fa-linkedin-square" aria-hidden="true"></i></a> <a herf="#"><i class="fa fa-pinterest-square" aria-hidden="true"></i></a>------></p>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                <a href="<?=base_url()?>assets/image/gallery/gallery_2.jpg" class="fancybox" rel="ligthbox">
                    <img src="<?=base_url()?>assets/image/gallery/gallery_thumb_2.jpg" class="zoom img-fluid"  alt="Atithya services, Welcome and Assist, Delhi Airport">
            ...
            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                <a href="<?=base_url()?>assets/image/gallery/gallery_3.jpg" class="fancybox" rel="ligthbox">
                    <img src="<?=base_url()?>assets/image/gallery/gallery_thumb_3.jpg" class="zoom img-fluid"  alt="Encalm Lounge, Atithya Meet and Greet, Meet and Greet services, Airport Meet and Greet Services">
            ...
            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                <a href="<?=base_url()?>assets/image/gallery/gallery_4.jpg" class="fancybox" rel="ligthbox">
                    <img src="<?=base_url()?>assets/image/gallery/gallery_thumb_4.jpg" class="zoom img-fluid"  alt="Atithya baggage assistance, Airport baggage assistance">
            ...
            <div class="py-4"><video width="100%" controls preload="none" poster="<?=base_url()?>assets/image/gallery/poster.jpg">
           ...
           <div id="shareicons" class="modal fade">

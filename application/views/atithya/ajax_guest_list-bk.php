...
if(!empty($allguest))
       ...
       <?php }}}?>
            ...
            <div class="form-group col-md-2">
              <label for="" class="d-none">First Name</label>
              <input type="text" class="form-control first_name" id="e_guest_fname_<?=$val->id?>" name="" placeholder="First Name"  value="<?=!empty($val->name)?$val->name:'';?>" readonly>
            </div>
            <div class="form-group col-md-2">
              <label for="" class="d-none">Last Name</label>
              <input type="text" class="form-control last_name" id="e_guest_lname_<?=$val->id?>" name="" placeholder="Last Name"  value="<?=!empty($val->last_name)?$val->last_name:'';?>" readonly>
            </div>
            ...
            <div class="form-group col-md-1">
              ...
              <input type="text" class="form-control age" id="e_guest_age_<?=$val->id?>" name="" placeholder="Age"  value="<?=!empty($val->dob)?getAge($val->dob):'';?>" readonly>
            </div>
            <div class="form-group col-md-2">
              <label for="" class="d-none">Passport/Govt</label>
              <input type="text" class="form-control passport" id="e_guest_passport_<?=$val->id?>" name="" placeholder="Passport/Govt ID" value="<?=!empty($val->passport)? $val->passport:'';?>" readonly>
            </div>

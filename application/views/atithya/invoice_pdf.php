...
<body style="font-family: 'Open Sans', Arial, Helvetica, sans-serif; font-size: 11px; padding: 0px 0px; margin: 0px 0px; color: #464646;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center; padding: 8px 8px; border: solid 1px #dedede; border-top: solid 0px #dedede; border-collapse: collapse;" width="40%" colspan="2">
                                            ...
                                            <small><?php echo !empty($mainData->datalist[0]->date) ? date('D, d-M-Y', strtotime($mainData->datalist[0]->date)) : 'NA'; ?> <?php if ($service_type[1] == 'Departure') echo !empty($mainData->datalist[0]->dtime) ? $mainData->datalist[0]->dtime : '';
                                                                                                                                                                        else echo !empty($mainData->datalist[0]->atime) ? $mainData->datalist[0]->atime : ''; ?> Hrs (IST)</small>
                                        </td>
                                    </tr>
                                    <tr>
    ...
    if ($airport_location[0] == 8254) { ?>
        <section style="width: 700px; margin: 10px auto; font-size: 13px; ">
            <img src="<?= base_url() ?>assets/image/invoice_folder/hyderabad-invoice.jpg" alt="hyderabad-invoice" width="100%">
        </section>
    <?php
    }
    if ($airport_location[0] == 8008) { ?>
        <section style="width: 700px; margin: 10px auto; font-size: 13px;">
            <img src="<?= base_url() ?>assets/image/invoice_folder/delhi-invoice.jpg" alt="delhi-invoice" width="100%">


        </section>
    <?php
    } else if ($airport_location[0] == 9392) { ?>
        <section style="width: 700px; margin: 10px auto; font-size: 13px;">
            <img src="<?= base_url() ?>assets/image/invoice_folder/goa-invoice.jpg" alt="goa-invoice" width="100%">
        </section>
    <?php
    }
    ?>

  ...
  <section class="mamber-card-checkout">
    <div class="container search-box">
	  ...
	  <div class="section-title" style="text-align:center">
            <p>
                <?php if((!empty($mainData->datalist[0]->state)?$mainData->datalist[0]->state:'') != 'sale') { ?>
                Thank you! Your Appointment Request has been sent. The Team will revert to your request within 4 Hours.
                <?php } else { ?>
...
<li class="list-group-item d-md-flex justify-content-between align-items-center"> <span><i class="fas fa-couch"></i>&nbsp;Service Category</span>
    <p class="badge badge-primary badge-pill text-dark"><?=!empty($mainData->datalist[0]->service_category)?ucfirst(str_replace('_',' ',$mainData->datalist[0]->collection_remarks)):'';?> </p>
  </li> 

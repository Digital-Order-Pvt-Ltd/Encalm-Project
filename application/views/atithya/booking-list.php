  ...
  <section class="mamber-card">
    <div class="container search-box">
      <div class="row">
          ...
          <table class="table table-striped table-bordered pb-3 pt-3" cellpadding="0" cellspacing="0" width="100%">
 ...
 <?php if(!empty($datalist)){
	...
	if(!empty($allsearchdata->message) and $allsearchdata->message=='data found.'){
     ...
     <tr>
	  ...
	  echo str_replace('0000','NA',!empty($arrival_flight[1])?$arrival_flight[1]:'NA');
	  ?></td>
	  <td> <?php $departure_flight = $val->departure_flight_id;
	  echo str_replace('0000','NA',!empty($departure_flight[1])?$departure_flight[1]:'NA');
	  ?></td>
	  ...
	  ?></td>
      <td><?php echo $val->booking_stage;
	  ?></td>
      
	  <td width="130px"> <a  href="<?=base_url('atithya/user/bookingdetail/'.$val->id);?>" class="btn btn-primary float-end btn-sm small"><i class="fas fa-eye"></i> View</a></td>
    </tr> 
			<?php  $i++;  }}}}  ?>
  </tbody>
</table>

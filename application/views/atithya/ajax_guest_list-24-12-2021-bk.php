...
<form id="g_addguestform" name="" method="post" action="<?=base_url('user/addguest')?>" class="custom-search-from pt-3 formfloats" enctype="application/x-www-form-urlencoded">
          <div class="row">
          	<div class="col-md-2">
          		<div class="row">
				  	<div class="col-md-3 pd-10"></div>
			            <div class="form-group col-md-9 pd-10">
...
<div class="row formfloats" data-id="<?=$i?>">
        ...
        <div class="col-md-3 ml-n-9">
			...
			<div class="form-group col-md-2 pd-10 ml-p-3">
				  <label for="" class="d-none">Gender</label>
            ...
            <div class="form-group col-md-2 pd-10 ml-p-5">
			 <input type="hidden" class="form-control age" id="1_e_guest_age_<?=$val->id?>" name="" placeholder=""  value="<?=!empty($val->dob)?getAge($val->dob):'';?>" readonly>	
              ...
              <input type="text" class="form-control datepicker" id="e_guest_age_<?=$val->id?>" name="" placeholder=""  value="<?=!empty($val->dob)?date('d-m-Y',strtotime($val->dob)):'';?>" readonly>

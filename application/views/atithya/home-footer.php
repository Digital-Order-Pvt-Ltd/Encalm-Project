      ...
      <div class="row justify-content-center ">
          <div class="col-lg-4">
           ...
           <a href="#top" class="back-to-top d-flex align-items-center justify-content-center active">
              <img src="<?=base_url()?>assets/image/plane.png" alt="encalm" width="4.625rem" />
            </a>
...
<div id="divWait" style="background-color: rgba(0, 0, 0, 0.4); filter: alpha(opacity=50);
 opacity: 0.8; width: 100%; top: 0rem; left: 0rem; 
 z-index: 1040;
...
<div id="divWaitInner" 
    ...
    right: 40%;
     ...
     width:20%;
     text-align: center;
    background-color: White; height:7.5rem;">
  <table style="background-color: White; 
        font-family: Sans-Serif; text-align: center;
        border: solid .0625rem #787878; color: #000000; 
        padding-bottom:.3125rem;
        width: 100%; 
        
        height: inherit; padding: .9375rem;">
    <tr>
      <td style="text-align: inherit; padding:.625rem"><i class="fa fa-refresh  fa-spin fa-5x fa-fw" style="margin-top:.625rem; color:black"></i> <br />
        <br />
        <b style="font-family:Arial, Verdana; font-size:.9375rem;"> Please wait..</b></td>
    </tr>
  </table>
</div>
<!-----------------------Please Wait Close---------------------------> 
...
<style>
.bg-blue{background-image:url("<?=base_url()?>assets/image/footer.jpg"); background-repeat: no-repeat; background-size: cover; background-position: center; padding:3.75rem 0rem;}
footer hr{color:#ffffff!important;}
  ...
  footer ul {list-style:none;margin:0rem 0rem;padding:0rem 0rem;}
  footer .foots li{padding:.1875rem 0rem!important;}
  footer .btn-main {
    width: 100%;
    background-color: #cda45e;
    border: solid .0625rem #cda45e;
...
footer .back-to-top:hover {
  ...
  footer .back-to-top{position: relative!important; right: 0!important; bottom:0!important; border:0rem!important;}
  footer .color-main {
    color: #cda45e;
}

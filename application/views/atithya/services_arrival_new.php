    ...
    <div class="container position-relative text-center text-lg-start" data-aos="zoom-in" data-aos-delay="100">
        <div class="row">
            <div class="col-md-7 order-md-2 m-auto text-right text-white">
                ...
                <p class="mb-3 text-white">Make you arrival count with Atithya Arrival services! Our team of trained
                    cohorts go the extra mile to ensure a pleasant and smooth arrival experience for you and your loved
                    ones</p>
            </div>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="ccontent">
                ...
                <div class="section-title-services">
                    ...
                    <div class="d-flex align-items-center gap-4 mb-5 mobile-flex">
                        <div class="col-md-6 over-flow">
                            ...
                            <table class="table shadow custom-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Assistance from the aerobridge or bus gate as per arrival (bridge connecting
                                            aircraft & terminal)</td>
                                    ...
                                    <tr>
                                        <td>Lounge Access for 2 hours (Lounge for arrivals available only at Terminal 3)
                                        </td>
                                        <td></td>
                                        <td><span class="red-circle"></span></td>
                                        <td><span class="red-circle"></span></td>
                        ...
                        <div class="col-md-6">
                        <img src="<?=base_url('atithya_assets/assets/')?>img/services_1.jpg"
                                    class=" img-international  marginLeft-25" />
                          
                        </div>
                    </div>
                    <div class="d-flex align-items-center gap-4 mobile-flex">
                        <div class="col-md-6">
                        <img
                                    src="<?=base_url('atithya_assets/assets/')?>img/Namaste-Atithya-Team.png"
                                    class=" img-international marginLeft-25"
                                    alt="Encalm Lounge, Atithya services, Hyderabad Airport" /> 
                            <!-- <p class="pt-3 mt-md-5 mt-2"><img
                                    src="<?=base_url('atithya_assets/assets/')?>img/service_new2.png"
                                    class=" img-international marginLeft-25"
                            ...
                            <div class="section-title-services">
                                ...
                                <table class="table shadow custom-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Assistance from the aerobridge or bus gate as per arrival (bridge
                                                connecting aircraft & terminal)</td>
                                            <td><span class="red-circle"></span></td>
                                            <td><span class="red-circle"></span></td>
                                            <td><span class="red-circle"></span></td>
                                        ...
                                        <tr>
                                            <td>Lounge access* (Lounge for arrivals available only at Terminal 3)</td>
                    ...
                    <div class="row terms-notes pt-5">
                        <ul>
                            ...
                            <li> The services are subject to availability.</li>
                             <li> Please contact your relationship manager or
                ...
                <div class="section-title-services">
                    ...
                    <div class="d-flex align-items-center  gap-4 mb-5 mobile-flex">
                        <div class="col-md-6 over-flow">
                            ...
                            <table class="table shadow custom-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Assistance from the aerobridge or bus gate as per arrival</td>
                                        <td><span class="red-circle"></span></td>
                                        <td><span class="red-circle"></span></td>
                                        <td><span class="red-circle"></span></td>
                        ...
                        <div class="col-md-6">
                            <p class="pt-3 mt-md-5"><img src="<?=base_url('atithya_assets/assets/')?>img/Namaste-Atithya-Team.png"
                            ...
                            <div class="section-title-services">
                                ...
                                <table class="table shadow custom-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Assistance post-hand baggage area of customs</td>
                                            <td><span class="red-circle"></span></td>
                                            <td><span class="red-circle"></span></td>
                                            <td><span class="red-circle"></span></td>
                ...
                <div class="section-title-services">
                    ...
                    <div class="d-flex align-items-center mobile-flex gap-4 mobile-flex">
                        <div class="col-md-6 ">
                            <p class="pt-3 mt-md-5 mt-2"><img
                                    src="<?=base_url('atithya_assets/assets/')?>img/imgdepart.png"
                                    class=" img-international marginLeft-25" /></p>
                        </div>
                        <div class="col-md-6 over-flow">
                            <div class="section-title-services">
                                ...
                                <table class="table shadow custom-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Assistance from post-hand baggage area of customs</td>
                                            <td><span class="red-circle"></span></td>
                                            <td><span class="red-circle"></span></td>
                                            <td><span class="red-circle"></span></td>

        ...
        <div class="ccontent mt-5 pt-5">
          ...
          <div id="elite">
            ...
            <div class="col-md-4">
              ...
              <div class="col-md-4">
                <div class="splan mt-4 shadow p-3 mb-5 bg-white rounded">
                  <p><img class="w-100" style="margin-bottom:5px;" alt="Your ticket to a magical Goa experience" src="<?= base_url('') ?>/assets/image/logo/atithya-location.jpg"></p>
                  <!--p><img class="w-100" style="margin-bottom:5px;" src="<?= base_url('') ?>/assets/image/blog-header.jpg"></p-->
                  <h4 class="mt-3" style="min-height: 86px;"><a href="<?= base_url('') ?>blogs/Your-ticket-to-a-magical-Goa-experience">Your ticket to a magical Goa experience</a></h4>
                  <p class="text-right"><a href="<?= base_url('') ?>blogs/Your-ticket-to-a-magical-Goa-experience" class="btn btn-primary my-2 px-3 py-1 btn-sm">Read More</a></p>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="splan mt-4 shadow p-3 mb-5 bg-white rounded">
                  ...
                  <!--p><img class="w-100" style="margin-bottom:5px;" src="<?= base_url('') ?>/assets/image/blog-header.jpg"></p-->
                  <h4 class="mt-3" style="min-height: 86px;"><a href="<?= base_url('') ?>blogs/making-your-journey-through-airport-seamless-with-atithya">Making Your Journey Through Airport Seamless with Atithya</a></h4>
                  <p class="text-right"><a href="<?= base_url('') ?>blogs/making-your-journey-through-airport-seamless-with-atithya" class="btn btn-primary my-2 px-3 py-1 btn-sm">Read More</a></p>
                </div>
              </div>
              <div class="col-md-4">
                <div class="splan mt-4 shadow p-3 mb-5 bg-white rounded">
                  <p><img class="w-100" style="margin-bottom:5px;" alt="Arrive In Style At The Delhi Airport With Atithya Services By Encalm Hospitality" src="<?= base_url('') ?>/assets/image/blog_2.jpg"></p>
                  <!--p><img class="w-100" style="margin-bottom:5px;" src="<?= base_url('') ?>/assets/image/blog-header.jpg"></p-->
                  <h4 class="mt-3"><a href="<?= base_url('') ?>blogs/arrive-in-style-at-the-delhi-airport-with-atithya-services-by-encalm-hospitality">Arrive In Style At The Delhi Airport With Atithya Services By Encalm Hospitality</a></h4>
                  <p class="text-right"><a href="<?= base_url('') ?>blogs/arrive-in-style-at-the-delhi-airport-with-atithya-services-by-encalm-hospitality" class="btn btn-primary my-2 px-3 py-1 btn-sm">Read More</a></p>
                </div>
              </div>
              <div class="col-md-4">
                <div class="splan mt-4 shadow p-3 mb-5 bg-white rounded">
                  <p><img class="w-100" style="margin-bottom:5px;" alt="Arrive In Style At The Delhi Airport With Atithya Services By Encalm Hospitality" src="<?= base_url('') ?>/assets/image/blog_3.jpg"></p>
                  <h4 class="mt-3"><a href="<?= base_url('') ?>blogs/5-ways-the-encalm-lounge-adds-magic-to-your-journey">Upgrade Your Travel Style: 5 Ways The Encalm Lounge Adds Magic To Your Journey</a></h4>
                  <p class="text-right"><a href="<?= base_url('') ?>blogs/5-ways-the-encalm-lounge-adds-magic-to-your-journey" class="btn btn-primary my-2 px-3 py-1 btn-sm">Read More</a></p>
                </div>
              </div>
              <div class="col-md-4">
                <div class="splan mt-4 shadow p-3 mb-5 bg-white rounded">
                  <p><img class="w-100" style="margin-bottom:5px;" alt="Arrive In Style At The Delhi Airport With Atithya Services By Encalm Hospitality" src="<?= base_url('') ?>/assets/image/blog_4.jpg"></p>
                  <h4 class="mt-3" style="min-height: 116px;"><a href="<?= base_url('') ?>blogs/5-ways-the-encalm-spa-improves-your-life">A Haven Of Serenity For Weary Travelers: 5 Ways The Encalm Spa Improves Your Life!</a></h4>
                  <p class="text-right"><a href="<?= base_url('') ?>blogs/5-ways-the-encalm-spa-improves-your-life" class="btn btn-primary my-2 px-3 py-1 btn-sm">Read More</a></p>
                </div>
              </div>
              <div class="col-md-4">
                <div class="splan mt-4 shadow p-3 mb-5 bg-white rounded">
                  <p><img class="w-100" style="margin-bottom:5px;" alt="Arrive In Style At The Delhi Airport With Atithya Services By Encalm Hospitality" src="<?= base_url('') ?>/assets/image/blog_5.jpg"></p>
                  <h4 class="mt-3" style="min-height: 116px;"><a href="<?= base_url('') ?>blogs/4-ways-to-travel-better-this-holiday-season">4 Ways To Travel Better This Holiday Season</a></h4>
                  <p class="text-right"><a href="<?= base_url('') ?>blogs/4-ways-to-travel-better-this-holiday-season" class="btn btn-primary my-2 px-3 py-1 btn-sm">Read More</a></p>
                </div>
              </div>
              <div class="col-md-4">
                <div class="splan mt-4 shadow p-3 mb-5 bg-white rounded">
                  <p><img class="w-100" style="margin-bottom:5px;" alt="Arrive In Style At The Delhi Airport With Atithya Services By Encalm Hospitality" src="<?= base_url('') ?>/assets/image/blog_6.jpg"></p>
                  <h4 class="mt-3" style="min-height: 86px;"><a href="<?= base_url('') ?>blogs/5-ways-in-which-the-brand-new-encalm-lounge">5 Ways In Which The Brand New Encalm Lounge Will Improve Your Airport Experience</a></h4>
                  <p class="text-right"><a href="<?= base_url('') ?>blogs/5-ways-in-which-the-brand-new-encalm-lounge" class="btn btn-primary my-2 px-3 py-1 btn-sm">Read More</a></p>
                </div>
              </div>
              <div class="col-md-4">
                <div class="splan mt-4 shadow p-3 mb-5 bg-white rounded">
                  <p><img class="w-100" style="margin-bottom:5px;" alt="Arrive In Style At The Delhi Airport With Atithya Services By Encalm Hospitality" src="<?= base_url('') ?>/assets/image/blog_7.jpg"></p>
                  <h4 class="mt-3" style="min-height: 86px;"><a href="<?= base_url('') ?>blogs/6-ways-atithya-is-redefining-the-airport">6 Ways Atithya Is Redefining The Airport Experience For Senior Citizens</a></h4>

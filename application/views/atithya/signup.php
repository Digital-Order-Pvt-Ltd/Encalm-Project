  ...
  <div class="pt-5 bg-light">
        <div class="section-title text-center">
           ...
           <?php if(!empty($this->session->flashdata('success'))) {?>
            ...
            <h3 class="btn btn-danger"> <center><?=$this->session->flashdata('success')?></center></h3>
    ...
    <div class="container search-box">
      <div class="row">
        <div class="col-lg-12">
           ...
           <form id="signup_user_form" name="" method="post" action="" class="custom-search-from formfloats" enctype="application/x-www-form-urlencoded">
                    ...
                    <div class="row">
                  	...
                  	<div class="form-group col-md-12">
                          <div class="form-check">
                            ...
                            <label class="form-check-label" for="exampleCheck11"><span class="f-12">I Agree to the  <a class="open-button" popup-open="popup-1" href="javascript:void(0)">Terms & Conditions*</a> and <a class="open-button" popup-open="popup-2" href="javascript:void(0)">Privacy Policy*</a></span></label>
                          </div>
                      </div>
                      <!------------------------------Popup------------------------------------->
					  ...
					  <div class="form-group col-md-12">
                          <div class="form-check">
                             <button type="submit" id="submit" name="submit" class="btn btn-red"  role="button" aria-disabled="false" style="float:right;">Sign Up</button>
                          </div>
                      </div>
...
<script>
$("form#signup_user_form").submit(function(event) 
{
...
if(placard_country != "")
{
 $.ajax({
			...
			data: {'placard_country':placard_country},
			dataType: "html",

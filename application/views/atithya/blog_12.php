<?php 
$meta_title = 'Atithya Meet and Greet - Experience Magical Goa | Encalm Blog';
$meta_description = 'Atithya Goa is here to take care of everything for you with this premium airport assistance service at New Goa airport.';
$meta_website_description = 'Atithya Goa is here to take care of everything for you with this premium airport assistance service at New Goa airport.';

$meta_header ='Atithya Meet and Assist: Your ticket to a magical Goa experience';
...
<?php
include('/home/ecuser/public_html/application/views/navigation.php'); ?>
  ...
  <section id="services" class="services">
    <div class="container" data-aos="fade-up">
      ...
      <div class="ccontent mt-5 pt-5">
        <h1 style="color: #cda45e;" class="mt-4" align="center">Your ticket to a magical Goa experience</h1>
		<h2 style="color: #cda45e;" class="mt-4" align="center">Enjoy VIP treatment with premium airport assistance</h2>
        <div id="elite">
        <div class="row mb-5">
          <div class="col-md-12">
            <div class="splan mt-4">
                <p class="text-center"><img class="w-100" style="margin-bottom:5px;" alt="Encalm Lounge: Where Goan hospitality meets luxury travel" src="<?=base_url('')?>/assets/image/gallery/poster.jpg"></p>
                <p class="text-secondary">Welcome to Goa, the land of sun, sand, and sea! With its vibrant culture, delicious cuisine, and gorgeous beaches, this paradise destination has been enchanting travelers from all over the world for years. But before you hit the streets and the sands, let Atithya Meet and Assist add some magic to your trip!</p>
                
				<p class="text-secondary">Picture this: you arrive at the airport, tired and cranky from your long journey. But wait, who's that waiting for you with a welcoming smile? It's your dedicated Atithya executive, ready to guide you through every step of the way. Say goodbye to those confusing formalities because Atithya is here to take care of everything for you! This premium airport assistance service is your key to a magical and stress-free vacation.  All you have to do is sit back, relax, and soak in the warm and personalized service.</p>
				
				<p class="text-secondary">But that’s not all! With their concierge service and porter service, you can be sure that every detail is taken care of, leaving you free to explore the soulful atmosphere and vibrant culture of Goa.</p>
				
				<p class="text-secondary">And the cherry on the cake - the Encalm Lounge offers a range of amenities to make your transit feel like a luxurious escape. Sip on a refreshing beverage or indulge in delicious treats while you surf the free Wi-Fi and unwind in style.  </p>
				
				<p class="text-secondary">So don't wait - book your Atithya experience today and let them help you discover the true essence of Goa. After all, as they say in this magical land - “Susegad." So, take it easy, enjoy life, and let Atithya Meet and Assist take care of the rest!</p>
				
				<p class="text-secondary">For more information and bookings, email us at guest.services@encalm.com or call us on +91 9289366950.</p>

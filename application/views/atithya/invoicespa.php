...
<link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;700&display=swap" rel="stylesheet">
  ...
  <?php 
	...
	echo '<div style="display: none;">';p($allsearchdata);echo '</div>';
	...
	foreach($itemData->datalist as $i) {
...
?></strong>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center; padding: 8px 8px; border: solid 1px #dedede; border-top: solid 0px #dedede; border-collapse: collapse;" width="25%">
                                        ...
                                        <strong style="text_primary">Travel Date</strong><br>

                                        <small><?php echo !empty($mainData->datalist[0]->date )?date('D, d-M-Y',strtotime($mainData->datalist[0]->date)) :'NA'; ?> </small>
                        ...
                        <table style="font-size: 13px; width: 100%; border-collapse: collapse; margin: 0px 0px;" width="100%" cellspacing="0" cellpadding="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th width="12%" style="padding: 8px 8px; border: solid 1px #dedede; border-top: solid 0px #dedede; border-collapse: collapse;">S No</th>

                                    <th width="22%" style="padding: 8px 8px; border: solid 1px #dedede; border-top: solid 0px #dedede; border-collapse: collapse;">Guest Name</th>

                                    <th width="22%" style="padding: 8px 8px; border: solid 1px #dedede; border-top: solid 0px #dedede; border-collapse: collapse;">Age (In yrs.)</th>

                                    <th width="22%" style="padding: 8px 8px; border: solid 1px #dedede; border-top: solid 0px #dedede; border-collapse: collapse;">Passport/ Govt. ID</th>

                                    <th width="22%" style="padding: 8px 8px; border: solid 1px #dedede; border-top: solid 0px #dedede; border-collapse: collapse;">Therapist Pref</th>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center; padding: 8px 8px; border: solid 1px #dedede; border-top: solid 0px #dedede; border-collapse: collapse;"><small><?=!empty($guest->therapist_preference)?ucfirst($guest->therapist_preference):''?></small></td>
                ...
                <tr>
                    ...
                    <th style="font-size: 13px; background: #152248; color: #ffffff; padding: 10px 10px; text-align: left;">Details of Encalm Spa Services:</th>
                         ...
                         <table style="font-size: 13px; width: 100%; border-collapse: collapse; margin: 0px 0px;" width="100%" cellspacing="0" cellpadding="0">
                             ...
                             <tbody>
                                 ...
                                 <tr>
                                     ...
                                     <td style="text-align: center; padding: 5px 5px; border: solid 1px #dedede; border-top: solid 0px #dedede; border-collapse: collapse;">9.0 %</td>

                                     <td style="text-align: center; padding: 5px 5px; border: solid 1px #dedede; border-top: solid 0px #dedede; border-collapse: collapse;"><?=$sgst=sprintf ("%.2f",(($NetAmount*9)/100),2)?> </td>

                                     <td style="text-align: center; padding: 5px 5px; border: solid 1px #dedede; border-top: solid 0px #dedede; border-collapse: collapse;">9.0 %</td>

                                     <td style="text-align: center; padding: 5px 5px; border: solid 1px #dedede; border-top: solid 0px #dedede; border-collapse: collapse;"><?=$cgst=sprintf ("%.2f",(($NetAmount*9)/100),2)?> </td>

                                     <td style="text-align: center; padding: 5px 5px; border: solid 1px #dedede; border-top: solid 0px #dedede; border-collapse: collapse;">0.00</td>

                                     <td style="text-align: center; padding: 5px 5px; border: solid 1px #dedede; border-top: solid 0px #dedede; border-collapse: collapse;">0.00</td>

                                     <td style="text-align: right; padding: 5px 5px; border: solid 1px #dedede; border-top: solid 0px #dedede; border-collapse: collapse;">&#8377;<?=$sgst+$cgst?> </td>
                                 ...
                                 <tr>
                                     ...
                                     <td style="text-align: right; padding: 5px 5px; border: solid 1px #dedede; border-top: solid 0px #dedede; border-collapse: collapse;">&#8377;<?php echo $sgst+$cgst+$NetAmount; ?></td>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center; padding: 8px 8px; border: solid 1px #dedede; border-top: solid 0px #dedede; border-collapse: collapse;">
                                        ...
                                        <!-- <p style="margin: 2px 0px;"><a target="_blank" href="https://links.encalm.com/assets/spa-menu.pdf">Click here</a> to read through our Spa Menu and Cancellation Policy.</p> -->

                                        <p style="margin: 2px 0px;">For Spa booking and queries please feel to write to us on  <a href="mailto:spa@encalm.com">spa@encalm.com</a></p>

...
<?php for($i=1;$i<=$this->session->userdata('s_adult');$i++){  $increment = $increment+1; ?>
  <div class="row d-flex align-items-center mb-3 justify-content-end my_data_<?=$increment?>" id="s_adult_<?php echo $i; ?>">
	...
	<div class="form-group col-md-1 pd-10">
	  ...
	  <span class="caret"></span>
	  <select id="adult_gender_<?=$i?>" name="adult_gender[]" class="form-control gender my_gender_<?=$increment?>">
	...
	<div class="form-group col-md-1 pd-10">
      <input type="text" class="form-control age my_age_<?=$increment?>" id="adult_age_<?=$i?>" name="adult_age[]" placeholder="">
...
<?php if(!empty($this->session->userdata('s_child'))){ for($i=1;$i<=$this->session->userdata('s_child');$i++){  $increment = $increment+1;?>
  <div class="row d-flex align-items-center mb-3 justify-content-end my_data_<?=$increment?>" id="s_child_<?php echo $i; ?>">
	...
	<div class="form-group col-md-1 pd-10">
      <label for="" class="d-none">Gender*</label>
	  <span class="caret"></span>
	  <select id="child_gender_<?=$i?>" name="child_gender[]" class="form-control gender my_gender_<?=$increment?>">
        <option value="">Gender*</option>
        <option value="male">Male</option>
        <option value="female">Female</option>
		<option value="other">Other</option>
    ...
    <div class="form-group col-md-1 pd-10">
      <input type="text" class="form-control age my_age_<?=$increment?>" id="child_age_<?=$i?>" name="child_age[]" placeholder="">
      <label for="" class="floating-label">Age*</label>
    </div>
    <div class="form-group col-md-2 pd-10">
  ...
  <div class="row d-flex align-items-center mb-3 justify-content-end my_data_<?=$increment?>" id="s_infant_<?php echo $i; ?>">
	...
	<div class="form-group col-md-1 pd-10">
      <label for="" class="d-none">Gender</label>
	  <span class="caret"></span>
	  <select id="infant_gender_<?=$i?>" name="infant_gender[]" class="form-control gender my_gender_<?=$increment?>">
        <option value="">Gender*</option>
        <option value="male">Male</option>
        <option value="female">Female</option>
		<option value="other">Other</option>
    ...
    <div class="form-group col-md-1 pd-10">
      <input type="text" class="form-control age my_age_<?=$increment?>" id="infant_age_<?=$i?>" name="infant_age[]" placeholder="">
      <label for="" class="floating-label">Age</label>
    </div>
    <div class="form-group col-md-2 pd-10">

...
//	$payment_status = 'Pending';
	...
	$dbrow = CustomQuery("select new_status,reference_no from tbl_post_payment_details where sale_id=$id limit 1");
	if(!empty($dbrow[0]->new_status)) $payment_status = $dbrow[0]->new_status;
	?>
				 ...
				 <br>Payment Id : <?=!empty($dbrow[0]->new_status)?$dbrow[0]->reference_no:'NA'?>
				 <br>Thank you!
<?php }?>
</p>

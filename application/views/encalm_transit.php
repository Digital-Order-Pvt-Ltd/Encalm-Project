        ...
        <div class="row">
          <div class="col-lg-6 m-auto">
            <div class="">
                  ...
                  <p class="text-center color-black"><i class="fa fa-map-marker" aria-hidden="true"></i> Level D Arrivals beside Café Nilofer, RGIA, Shamshabad</p>
                  <p class="text-center color-black mt-3 mb-0">Distance from key locations:</p>
                  <p class="text-center color-black"><strong>Charminar:</strong> 15 km (approx. 40 minutes)</p>
                  <p class="text-center color-black"><strong>Secunderabad Railway Station:</strong> 35 km (approx. 1 hour)</p>
                  <p class="text-center color-black"><strong>Mahatma Gandhi Bus Stand:</strong> 25 km (approx. 45 minutes)</p>
                  <p class="text-center color-black"><i class="fa fa-envelope color-blue" aria-hidden="true"></i> reservations@transitbyencalm.com </p>
                  <p class="text-center color-black"><i class="fa fa-phone color-blue" aria-hidden="true"></i> <a class="color-black" href="tel:+919289472139">+91 9289366950</a></p>
              </div>
          </div>
        </div>
    ...
    <div class="container shadow bg-white p-5">
      ...
      <input type="text" class="form-control custom-form shadow datepicker" id="to_date" name="booking_to_date" placeholder="" data-gtm-form-interact-field-id="0" required>
                ...
                <div class="form-group col-md-4 mt-2">
                  ...
                  <select name="child" id="child" class="form-control shadow custom-form">
                    <option value="">Select</option>
                    <option value="1">1</option>
                    <option value="2">2</option>
                    <option value="3">3</option>
                ...
                <div class="form-group col-md-6 mt-2">
                  ...
                  <select name="city" id="city" class="form-contro form-select shadow custom-form">
                    <option value="">Select</option>
                  </select>
                </div>
                <div class="form-group col-md-6 mt-2">
                ...
                <div class="form-group col-md-12">
                    <br/>
                  <button type="submit" id="submitbookform" name="submit" class="btn rounded btn-primary mt-2"> Book Now</button>
                </div>

                <div class="form-group col-md-12">
                <p class="mt-3 mb-0 color-black"><b>Note:</b></p>
                <p class="mt-1 mb-0 color-black">1. The age group would be as follows:</p>
                <ol>
                    <li>Infant: Under 6 years: Comp</li>
                    <li>Child: 6-11 years: Child Rate at 30% of Adult Rate</li>
                    <li>Adult: 12 years and above</li>
                </ol>
                <p class="mt-3 mb-0 color-black">2. The maximum number of individuals in a room can be 2</p>
                <p class="mt-3 mb-0 color-black">3. Breakfast is included only in 1 night plan</p>
                </div>

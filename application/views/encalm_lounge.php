      ...
      <div class="row">
        <nav>
          <div class="nav nav-tabs" id="nav-tab" role="tablist">
            <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">Delhi</button>
            <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Hyderabad</button>
            <button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">Goa</button>
          </div>
        </nav>
        ...
        <div class="col-lg-12">
          <div class="Lounge-carousel section-padding owl-carousel">
            <div class="testi">
               ...
               <img src="<?= base_url() ?>assets/image/lounge_images/lounge_img1.jpg" alt="Lounge Service">
                       </div>
            </div>
            <div class="testi">
              <div class="lounge_img">
                 <img src="<?= base_url() ?>assets/image/lounge_images/lounge_img2.jpg" alt="Lounge Service">
                       </div>
            </div>
            <div class="testi">
              <div class="lounge_img">
                <img src="<?= base_url() ?>assets/image/lounge_images/lounge_img3.jpg" alt="Lounge Service">
                       </div>
              </div>     
            <div class="testi">
              <div class="lounge_img">
                <img src="<?= base_url() ?>assets/image/lounge_images/lounge_img4.jpg" alt="Lounge Service">
                       </div>
            </div>      
            <div class="testi">
            <div class="lounge_img">

...
<section>
    ...
    <!--  </div>-->
    <!--</div>-->
          <p class="text-center text-secondary mt-4">Creating Delightful Experiences.<br/><br/>Keeping in mind our guest's comfort, Encalm has a dedicated airport lounge for travellers to relax. Crafted with expert precision, the Encalm lounge provides relief from the continuous bustle of the airport. Sit back and bask in luxury at the Encalm lounge.</p>
        </div>
      </div>
    </div>
</section>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="icon-serve">
                          <div class="box-icon text-center"><img src="<?=base_url()?>assets/image/louge/Bar.png" alt="Bar at lounge"> <p class="color-main text-center">Bar</p></div>
                          <div class="box-icon text-center"><img src="<?=base_url()?>assets/image/louge/F&amp;B.png" alt="F&B"> <p class="color-main text-center">F&B</p></div>
                          <div class="box-icon text-center"><img src="<?=base_url()?>assets/image/louge/Flight-Information.png" alt="Flight information"> <p class="color-main text-center">Flight Information</p></div>
                          <div class="box-icon text-center"><img src="<?=base_url()?>assets/image/louge/Lounge-Bay.png" alt="Lounge bay"> <p class="color-main text-center">Lounge Bay</p></div>
                          <div class="box-icon text-center"><img src="<?=base_url()?>assets/image/louge/Newspaper-and-Magazine.png" alt="Newspaper and Magazine"> <p class="color-main text-center">Newspaper And Magazine</p></div>
                          <div class="box-icon text-center"><img src="<?=base_url()?>assets/image/louge/Wi-Fi.png" alt="Wi Fi"> <p class="color-main text-center">Wi Fi</p></div>
      ...
      <div class="row mb-5">
        ...
        <div class="col-lg-6">
            <div class="">
                  ...
                  <h5 class="color-main text-center">Delhi</h5>
                  <p class="text-center color-black"><i class="fa fa-map-marker" aria-hidden="true"></i> Mezzanine level, T3 International Departures, IGI Airport, New Delhi- 110037</p>

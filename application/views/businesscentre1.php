    ...
    <div class="container">
      <div class="row mb-3">
        ...
        <div class="row">
          ...
          <form id="bookform" name="" method="post" action="<?=base_url()?>businesscentre/booking">
              ...
              <div class="row">
                ...
                <div class="form-group col-md-6 mt-2">
                  <label class="floating-label values mb-1">Booking Date</label>
                  <input type="text" class="form-control datepicker" id="booking_date" name="booking_date" placeholder="" data-gtm-form-interact-field-id="0" required>
                </div>
                <div class="form-group col-md-6 mt-2">
                ...
                <div class="form-group col-md-6 mt-2">
                  ...
                  <select name="no_of_hrs" id="no_of_hrs" class="form-control" required>
                    <option value="">Select</option>
                ...
                <div class="form-group col-md-12">
                  <button type="submit" id="submitbookform" name="submit" class="btn btn-primary mt-2"> Book Now</button>
                </div>

...
is highly appreciated.</p>
  ...
  <section class="bg-white">
    <div class="container pt-4">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="enclam_prive_carousel section-padding owl-carousel">
            <div class="testi">
               <div class="lounge_img">
               <img src="<?= base_url() ?>assets/image/enclam_prive_images/enclam_prive_img1.jpg" alt="enclam prive">
                       </div>
            </div>
            <div class="testi">
              <div class="lounge_img">
                 <img src="<?= base_url() ?>assets/image/enclam_prive_images/enclam_prive_img2.jpg" alt="enclam prive">
                       </div>
            </div>
            <div class="testi">
              <div class="lounge_img">
                <img src="<?= base_url() ?>assets/image/enclam_prive_images/enclam_prive_img3.jpg" alt="enclam prive">
                       </div>
              </div>
     
            <div class="testi">
              <div class="lounge_img">
                <img src="<?= base_url() ?>assets/image/enclam_prive_images/enclam_prive_img4.jpg" alt="enclam prive">
                       </div>
            </div>
       
            <div class="testi">
            <div class="lounge_img">
            <img src="<?= base_url() ?>assets/image/enclam_prive_images/enclam_prive_img5.jpg" alt="enclam prive">
                       </div>
            </div>
          </div>
        </div>
  ...
  <script type="text/javascript">
    ...
    $('.enclam_prive_carousel').owlCarousel({
      loop: true,
      margin: 10,
      autoplay: true,
      responsive: {

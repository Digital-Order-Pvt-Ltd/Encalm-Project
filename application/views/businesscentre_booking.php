...
<section>
    ...
    <!--  </div>-->
    <!--</div>-->
          <div class="text-center text-secondary mt-5 pt-5" style="margin-bottom:200px;margin-top:100px"><br/><br/>
    <h5 class="color-main text-center f-36 mt-5">Thank you for your booking request<br/> Our team will contact you shortly with availability</h5>
    
  <!--  <p>Thank you for your booking request. Our team will contact you shortly with availability.</p>-->
    <pre>
    <?php
    if(isset($_POST['submit']) && isset($_POST['bookingform'])) {
        $array = array(
            ...
            'booking_date'=>!empty($this->input->post( 'booking_date' ))?date('Y-m-d H:i',strtotime($this->input->post( 'booking_date' ))):'',		

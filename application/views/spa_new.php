...
<body>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="departure_block">
            ...
            <ul>
              <li>Domestic Departure Lounges</li>
  ...
  <!-------------------Location-------------------------->
  <section class="mt-5 mb-5 location">
    <div class="container">
      <div class="row mb-5">
        <div class="col-md-12">
        ...
        <div class="col-lg-12">
          <div class="Lounge-carousel section-padding owl-carousel">
            <div class="testi">
               ...
               <img src="<?= base_url() ?>assets/image/lounge_images/lounge_img1.jpg" alt="1">
                       </div>
            </div>
            <div class="testi">
              <div class="lounge_img">
            ...
            <div class="testi">
              <div class="lounge_img">
                <img src="<?= base_url() ?>assets/image/lounge_images/lounge_img3.jpg" alt="2">
                       </div>
              </div>
     
            <div class="testi">
              <div class="lounge_img">
                <img src="<?= base_url() ?>assets/image/lounge_images/lounge_img4.jpg" alt="3">
                       </div>
            </div>
       
            <div class="testi">
            <div class="lounge_img">
            <img src="<?= base_url() ?>assets/image/lounge_images/lounge_img5.jpg" alt="4">
                       </div>
            </div>
          </div>
        </div>

...
.flip-card-back h2{color:#152248!important; font-family:Brandon!important; font-weight:600!important;}
  ...
  .box-icon{width: 14.5%;
    ...
    margin-right: 12px;
    height: 130px;}
  .box-icon p{margin-bottom:0px!important; font-size: 14px;}
  /*-------------------------Location----------------------------------*/
    ...
    .box-image{width: 295px;}
    .bor-bot{ padding-top:8px;}
    .icon-serve img{width:100%; }
...
.two-logo{position: absolute;
   ...
   .hamburger button { background: #00000000;
    ...
    .mails a{color:#152349!important;}
@media screen and (min-width: 937px) and (max-width: 1000px){
    ...
    margin-bottom: 15px;
        ...
        .video-position{margin-top:85px;}
        #navArea{height:90px;}
      .box-image {width: 160px;}
      .box-location h3{margin-top:15px; text-align: center;}
      .box-location h5{text-align:center;}
     ...
     #navArea ul.subMenu li a {
       ...
       .foo-book {
        ...
        .flip-card{width:350px;}
         ...
         .close-menu button{position: relative; right: 0; width: 100%; text-align: right; background: #0000; border: 0px; color: #ffffff; padding: 10px 15px 0px; font-size: 20px;}
         .text-primarys{padding: 15px 0px!important;}
         .mails a{color:#152349!important; display:block; text-align:center;}
    }
</style>
        ...
        <div class="col-lg-10 pt-4 pt-lg-0 content">
          ...
          <div class="box-location">
              <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <h5 class="color-blue f-22"><i class="fa fa-map-marker" aria-hidden="true"></i> Level E beside gate no. 21 SHA domestic departures RGI Airport, Shamshad 501218 Telangana</h5>
                    <p class="color-black mails"><a href="mailto:hyd.dom@encalm.com"><i class="fa fa-envelope color-blue" aria-hidden="true"></i> hyd.dom@encalm.com</a> <a href="tel:+918826697922"><i class="fa fa-phone color-blue" aria-hidden="true"></i> +91 8826697922</a></p>
          ...
          <div class="box-location">
              <div class="row">
                ...
                <div class="col-lg-8">
                    <h3 class="color-main f-28">Encalm Lounge</h3>
                    <h5 class="color-blue f-22"><i class="fa fa-map-marker" aria-hidden="true"></i> Level E beside gate no. 23 SHA international departures RGI Airport, Shamshad 501218 Telangana</h5>
                    <p class="color-black mails"><a href="mailto:hyd.int@encalm.com"><i class="fa fa-envelope color-blue" aria-hidden="true"></i> hyd.int@encalm.com</a> <a href="tel:+918826697923"><i class="fa fa-phone color-blue" aria-hidden="true"></i> +91 8826697923</a></p>
          ...
          <div class="box-location">
              <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <h5 class="color-blue f-22"><i class="fa fa-map-marker" aria-hidden="true"></i> RGI Airport, Hyderabad</h5>
                    ...
                    <h5 class="color-blue f-22 bor-bot">Services Available</h5>
                    <div class="icon-serve">
                          <div class="box-icon text-center"><img src="<?=base_url()?>assets/image/atithya/Airport-assistance.png" alt="Encalm"/> <p class="color-main text-center">Airport Assistance</p></div>
                          <div class="box-icon text-center"><img src="<?=base_url()?>assets/image/atithya/Buggy.png" alt="Encalm"/> <p class="color-main text-center">Buggy</p></div>
                          <div class="box-icon text-center"><img src="<?=base_url()?>assets/image/atithya/Concierge-Services.png" alt="Encalm"/> <p class="color-main text-center">Concierge Services</p></div>
                          <div class="box-icon text-center"><img src="<?=base_url()?>assets/image/atithya/Greeting-services.png" alt="Encalm"/> <p class="color-main text-center">Greeting Services</p></div>
                          <div class="box-icon text-center"><img src="<?=base_url()?>assets/image/atithya/Porter.png" alt="Encalm"/> <p class="color-main text-center">Porter</p></div>
          ...
          <div class="note">*Buggy, Porter and Wheelchair service is subject to availability</div>

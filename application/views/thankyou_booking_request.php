    ...
    <div class="container">
      <div class="row mb-3">
        ...
        <div class="row">
          ...
          <form id="bookform" name="" method="post" action="<?=base_url()?>services/businesscentre">
              ...
              <div class="row">
                ...
                <div class="form-group col-md-6 mt-2 dtpicker">
                  ...
                  <input type="date" class="form-control datepicker" id="date" name="booking_date" placeholder="" data-gtm-form-interact-field-id="0" required>
                </div>
                <div class="form-group col-md-6 mt-2">

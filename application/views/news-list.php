        ...
        <div class="row mb-5">
          ...
          <div class="col-md-12">
            ...
            <div class="splan mt-4">
                ...
                <p>Vikas Sharma, CEO of Encalm Hospitality Pvt Ltd, informs that the company is expected to invest nearly INR 200 crore in the next one year to set up exclusive traveller lounges to cater to Business travellers and HNIs in Delhi.</p>
        ...
        <hr>
          ...
          <div class="col-md-12">
            ...
            <div class="splan mt-4">
                ...
                <p>Encalm Hospitality specializes in curating & delivering standout experiences in airport meet & greet services. We caught up with Vikas Sharma, CEO, Encalm Hospitality to know more about the company.</p>
        ...
        <hr>
          ...
          <div class="col-md-12">
            ...
            <div class="splan mt-4">
                ...
                <p>Encalm Hospitality, which started with the opening of Encalm Lounge at T1 domestic airport in Delhi in early 2022, plans to operate another lounge for business class passenger flying out of T3 International Airport in the capital, with an aim to bring five-star hospitality to the airports that travellers get in a luxury hotel.</p>
        ...
        <hr>
          ...
          <div class="col-md-12">
            ...
            <div class="splan mt-4">
                ...
                <p>Find yourself relaxing when you're actually on a vacation, but with young kids!</p>

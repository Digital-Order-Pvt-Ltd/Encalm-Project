...
<section>
    ...
    <div class="container">
      ...
      <div class="col-lg-12">
        ...
        <div class="section-title text-center pt-1 mt-1">
      ...
      <div class="row">
        ...
        <div class="col-lg-10 pt-4 pt-lg-0 content">
          ...
          <div class="box-location">
              ...
              <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <h5 class="color-blue f-22"><i class="fa fa-map-marker" aria-hidden="true"></i> Manohar International Airport, Goa</h5>
          ...
          <div class="note">*Porter and Wheelchair service is subject to availability</div>

    ...
    <div class="container">
      ...
      <div class="col-lg-12">
        <div class="section-title text-center mb-5">
            <p><img src="<?=base_url()?>assets/image/Encalm-Logo-Primary.png" width="100"></p>
            <!--<h2>About</h2>-->
            <p>Greetings from Encalm Hospitality</p>
          </div>
      </div>
    </div>
      <div class="row text-center text-primarys">
        <div class="col-lg-12 my-4">Namaste!<br>Thank you for providing us with an opportunity to serve you. Our endeavor is to provide a delightful experience each time.</div>
      </div>
      <div class="row">
        <div class="col-lg-4 mb-4">
          <div class="card">
            <div class="card-body shadow bg-white rounded text-center">
              <p><img src="<?=base_url()?>assets/image/atithya/Atithya-Logo-Golden.jpg" class="h150"></p>
              <p><a href="<?=base_url()?>/feedback/atithya" class="btn btn-primary">Share Feedback</a></p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 mb-4">
          <div class="card">
            <div class="card-body shadow bg-white rounded text-center">
              <p><img src="<?=base_url()?>assets/image/logolounge.png" class="h150"></p>
              <p><a href="<?=base_url()?>/feedback/lounge" class="btn btn-primary">Share Feedback</a></p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 mb-4">
          <div class="card">
            <div class="card-body shadow bg-white rounded text-center">
              <p><img src="<?=base_url()?>assets/image/logospa.png" class="h150"></p>
              <p><a href="<?=base_url()?>/feedback/spa" class="btn btn-primary">Share Feedback</a></p>
            </div>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-12 my-1 text-center text-primarys">Based on your recent experience at our service, please take a moment to share your feedback.</div>
      </div>
    </div>
</section>

      ...
      <div class="row">
        <div class="col-lg-12  pt-lg-0 content">
          <div class="section-title text-center">
            <!--<h2>About</h2>-->
            <p class="mr-top-136"><img src="<?=base_url()?>assets/image/atithya/Atithya-Logo-Golden.jpg" alt="Atithya-Logo-Golden" title="Lounge Service" style="width: 150px;"></p>
          </div>
    <!--           <div class="row">-->
    <!--  <div class="col-lg-12">-->
    <!--    <div class="section-title text-center">-->
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="icon-serve">
                          <div class="box-icon text-center"><img src="<?=base_url()?>assets/image/atithya/Airport-assistance.png" alt="Airport Assistance"/> <p class="color-main text-center">Airport Assistance</p></div>
                          <div class="box-icon text-center"><img src="<?=base_url()?>assets/image/atithya/Buggy.png" alt="buggy service at airport"/> <p class="color-main text-center">Buggy</p></div>

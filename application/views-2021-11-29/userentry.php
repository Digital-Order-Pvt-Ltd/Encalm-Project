...
<?php for($i=1;$i<=$this->session->userdata('s_adult');$i++){ ?>
  <div class="row d-flex align-items-center mb-3">
    ...
    <div class="form-group col-md-2">
      ...
      <select id="adult_title_<?=$i?>" name="adult_title[]" class="form-control">
    ...
    <div class="form-group col-md-2">
      ...
      <input type="text" class="form-control" id="adult_first_name_<?=$i?>" name="adult_first_name[]" placeholder="First Name">
    </div>
    <div class="form-group col-md-2">
      <label for="" class="d-none">Last Name</label>
      <input type="text" class="form-control" id="adult_last_name_<?=$i?>" name="adult_last_name[]" placeholder="Last Name">
    </div>
	<div class="form-group col-md-2">
	...
	<div class="form-group col-md-2">
      ...
      <input type="text" class="form-control" id="adult_age_<?=$i?>" name="adult_age[]" placeholder="Age">
    </div>
	<div class="form-group col-md-2">
      <label for="" class="d-none">Class</label>
	  <span class="caret"></span>
    ...
    <div class="form-group col-md-2">
      ...
      <input type="text" class="form-control" id="adult_pnr_<?=$i?>" name="adult_pnr[]" placeholder="PNR No.">
    </div>
    <div class="form-group col-md-2">
      <label for="" class="d-none">Passport/Govt</label>
      <input type="text" class="form-control" id="adult_passport_<?=$i?>" name="adult_passport[]" placeholder="Passport/Govt ID">
    </div>
...
<?php if(!empty($this->session->userdata('s_child'))){ for($i=1;$i<=$this->session->userdata('s_child');$i++){ ?>
  <div class="row d-flex align-items-center mb-3">
    ...
    <div class="form-group col-md-2">
      <label for="" class="d-none">Title*</label>
      <span class="caret"></span>
      <select id="child_title_<?=$i?>" name="child_title[]" class="form-control">
        <option value="">Title*</option>
         <?php if(!empty($salutation)){ $salutation_data =json_decode($salutation); 
	   if(!empty($salutation_data->datalist)){
		foreach($salutation_data->datalist as $val){
    ...
    <div class="form-group col-md-2">
      <label for="" class="d-none">First Name</label>
      <input type="text" class="form-control" id="child_first_name_<?=$i?>" name="child_first_name[]" placeholder="First Name">
    </div>
    <div class="form-group col-md-2">
      <label for="" class="d-none">Last Name</label>
      <input type="text" class="form-control" id="child_last_name_<?=$i?>" name="child_last_name[]" placeholder="Last Name">
    </div>
	<div class="form-group col-md-2">
      <label for="" class="d-none">Gender</label>
	  <span class="caret"></span>
	  <select id="child_gender_<?=$i?>" name="child_gender[]" class="form-control">
        <option value="male">Male</option>
        <option value="female">Female</option>
    ...
    <div class="form-group col-md-2">
      <label for="" class="d-none">Age</label>
      <input type="text" class="form-control" id="child_age_<?=$i?>" name="child_age[]" placeholder="Age">
    </div>
	<div class="form-group col-md-2">
      <label for="" class="d-none">Class</label>
	  <span class="caret"></span>
    ...
    <div class="form-group col-md-2">
      <label for="" class="d-none">PNR No.</label>
      <input type="text" class="form-control" id="child_pnr_<?=$i?>" name="child_pnr[]" placeholder="PNR No.">
    </div>
    <div class="form-group col-md-2">
      <label for="" class="d-none">Passport/Govt</label>
      <input type="text" class="form-control" id="child_passport_<?=$i?>" name="child_passport[]" placeholder="Passport/Govt ID">
    </div>
    <div class=clearfix></div>
  </div>
  <?php  }}?>
  ...
  <div class="row d-flex align-items-center mb-3">
    ...
    <div class="form-group col-md-2">
      <label for="" class="d-none">Title*</label>
      <span class="caret"></span>
      <select id="infant_title_<?=$i?>" name="infant_title[]" class="form-control">
        <option value="">Title*</option>
         <?php if(!empty($salutation)){ $salutation_data =json_decode($salutation); 
	   if(!empty($salutation_data->datalist)){
		foreach($salutation_data->datalist as $val){
    ...
    <div class="form-group col-md-2">
      <label for="" class="d-none">First Name</label>
      <input type="text" class="form-control" id="infant_first_name_<?=$i?>" name="infant_first_name[]" placeholder="First Name">
    </div>
    <div class="form-group col-md-2">
      <label for="" class="d-none">Last Name</label>
      <input type="text" class="form-control" id="infant_last_name_<?=$i?>" name="infant_last_name[]" placeholder="Last Name">
    </div>
	<div class="form-group col-md-2">
      <label for="" class="d-none">Gender</label>
	  <span class="caret"></span>
	  <select id="infant_gender_<?=$i?>" name="infant_gender[]" class="form-control">
        <option value="male">Male</option>
        <option value="female">Female</option>
       </select>
	  </div>
    ...
    <div class="form-group col-md-2">
      <label for="" class="d-none">Age</label>
      <input type="text" class="form-control" id="infant_age_<?=$i?>" name="infant_age[]" placeholder="Age">
    </div>
	<div class="form-group col-md-2">
      <label for="" class="d-none">Class</label>
	  <span class="caret"></span>
    ...
    <div class="form-group col-md-2">
      <label for="" class="d-none">PNR No.</label>
      <input type="text" class="form-control" id="infant_pnr_<?=$i?>" name="infant_pnr[]" placeholder="PNR No.">
    </div>
    <div class="form-group col-md-2">
      <label for="" class="d-none">Passport/Govt</label>
      <input type="text" class="form-control" id="infant_passport_<?=$i?>" name="infant_passport[]" placeholder="Passport/Govt ID">
    </div>
    <div class=clearfix></div>
  </div>
  <?php  }}?>

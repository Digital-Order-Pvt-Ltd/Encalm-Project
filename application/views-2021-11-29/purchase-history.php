    ...
    <div class="row d-flex align-items-center">
      ...
      <div class="col col2 text-center"><i class="fas fa-ticket-alt fa-2x text-white mb-2"></i><br>
        ...
        <?=!empty($this->session->userdata("s_arrival_flight"))?$this->session->userdata("s_arrival_flight"):''?><br> 
		 <?=!empty($this->session->userdata("s_d_airline_name"))?$this->session->userdata("s_airline_name"):''?><br>
      ...
      <div class="col col3 text-center"><i class="fas fa-calendar-day fa-2x text-white mb-2"></i><br>
		...
		<?php if(!empty($this->session->userdata("s_category")) and $this->session->userdata("s_category")=='Transit'){ ?>
       <?=!empty($this->session->userdata("s_doa"))?$this->session->userdata("s_doa"):''?>&nbsp; <?=!empty($this->session->userdata("s_arrival_time"))?$this->session->userdata("s_arrival_time"):''?> <br> hrs (IST)<br>
	   
	    <?=!empty($this->session->userdata("s_dod"))?$this->session->userdata("s_dod"):''?>&nbsp; <?=!empty($this->session->userdata("s_DepartureTime"))?$this->session->userdata("s_DepartureTime"):''?> <br> hrs (IST)
		<?php } else {?> 
		  <?=!empty($this->session->userdata("s_doa"))?$this->session->userdata("s_doa"):''?>&nbsp; <?=!empty($this->session->userdata("s_arrival_time"))?$this->session->userdata("s_arrival_time"):''?> <br>hrs (IST)
		<?php }?> 
      ...
      <div class="col col5 text-center"><i class="fas fa-couch fa-2x text-white mb-2"></i><br>
		...
		<?php if(!empty($this->session->userdata("s_category")) and $this->session->userdata("s_category")=='Transit'){ ?>
        <?=!empty($this->session->userdata("s_doa"))?$this->session->userdata("s_doa"):''?>&nbsp;<?=!empty($this->session->userdata("s_arrival_service_time"))?$this->session->userdata("s_arrival_service_time"):''?>  <br>hrs (IST)<br>
		<?=!empty($this->session->userdata("s_dod"))?$this->session->userdata("s_dod"):''?> <br>
		
		<?php } else {?> 
		  <?=!empty($this->session->userdata("s_dod"))?$this->session->userdata("s_dod"):''?>&nbsp;<?=!empty($this->session->userdata("s_arrival_service_time"))?$this->session->userdata("s_arrival_service_time"):''?>  <br>hrs (IST)<br>
		<?php }?> 

<form id="transitForm" name="transitForm" method="post" action="<?=base_url('home/search');?>" class="custom-search-from" enctype="application/x-www-form-urlencoded" style="min-height: 395px;">
...
<input type="hidden" name="terminal_value" id="tad_terminal_value" value="" />
  ...
  <div class="row">
    <div class="form-group col-md-6">
	  ...
	  <select id="TransitAirportService" name="TransitAirportService" class="form-control" size="1" Onchange="getAirportData_2(this.value)">
        <option value="" data-id="0">Select Transit Via</option>
      </select>
	</div>
    <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-6">
      ...
      <span class="caret"></span>
      <select id="TransitFromAirtport" name="TransitFromAirtport" class="form-control" size="1" Onchange="getDeparting_2(this.value)">
    ...
    <div class="form-group col-md-6">
      ...
      <span class="caret"></span>
	   <select id="TransitToAirtport" name="TransitToAirtport" class="form-control" size="1" Onchange="getDeparting_3(this.value)">
        <option value=""  data-id="0">Select Departing At</option>
      </select>
    ...
    <div class="form-group col-md-4">
      ...
      <input type="text" id="Transitdoa" name="Transitdoa" class="form-control datepicker" placeholder="Date of Arrival" onchange="getTransitArrivalFlightList(this.value)" value="" />
    </div>
    <div class="form-group col-md-4">
    ...
    <div class="form-group col-md-4">
	  ...
	  <input type="text" id="TransitArrivalTimeId"  name="TransitArrivalTime" class="form-control time" maxlength="10" autocomplete="off" placeholder="Arrival Time*" onfocus="this.type='time'"  value="" onchange="getTransitArrivalTime(this.value)" />
    ...
    <div class="form-group col-md-4">
	  ...
	  <input type="text" id="TransitArrivalServiceTimeId"  name="TransitArrivalServiceTime" class="form-control time" maxlength="10" autocomplete="off" placeholder="Arrival Time*" onfocus="this.type='time'"  value=""   />
    ...
    <div class="form-group col-md-4">
      ...
      <i class="fas fa-calendar-alt"></i>
      <input type="text" id="Transitdod" name="Transitdod" class="form-control datepicker" placeholder="Date of Departure" onchange="getTransitDepartureFlightList(this.value)" value="" />
    </div>
    <div class="form-group col-md-4">
      <label for="" class="d-none">Flight No.*</label>
      <span class="caret"></span>
    ...
    <div class="form-group col-md-4">
      ...
      <i class="far fa-clock"></i>
      <input type="text" id="TransitDepartureTimeId"  name="TransitDepartureTime" class="form-control time" maxlength="10" autocomplete="off" placeholder="Departure Time*" onfocus="this.type='time'"  value=""   />
    </div>
...
{
	var from_airport = $('#TransitAirportService option:selected').text();
	var to_airport = $('#TransitFromAirtport option:selected').text();
	 
	var travel_date = $('#Transitdoad').val();
	if(from_airport=='')
	{
	...
	else
	{
			...
			data: {'MethodName':'get_flight_list','RequestType':"TransitArrivalFlightList","category":'Departure',"from_airport":from_airport,"to_airport":to_airport,"travel_date":travel_date},
			dataType: "json",
...
{
	var from_airport = $('#TransitAirportService option:selected').text();
	var to_airport = $('#TransitToAirtport option:selected').text();
	...
	else
	{
		...
		$.ajax({
			...
			data: {'MethodName':'get_flight_list','RequestType':"TransitDepartureFlightList","category":'Departure',"from_airport":from_airport,"to_airport":to_airport,"travel_date":travel_date},
			dataType: "json",
			 	success: function(data) { 
				 console.log(data); 
				const item=data;
				...
				const item=data;
			 	 if(item.message=='data found.' && item.status==true)
				 {
					 const ItemArray=item.datalist;
					  ...
					  var html='<option value="" data-id="0">Select Transit Via</option>';
						 for (let i = 0; i < ItemArray.length; i++) 
						 {
...
function getAirportData_2(val)
{
	...
	$("#TransitFromAirtport").html('<option value="" data-id="0">Select Departing From</option>');
	
	$("#TransitToAirtport").html('');
	$("#TransitToAirtport").html('<option value="" data-id="0">Select Departing At</option>');
			...
			//	 alert(item.message);
				 if(item.message=='data found.' && item.status==true)
				 {
					 const ItemArray=item.datalist;
					   ...
					   var html_1='<option value="" data-id="0">Select Departing At</option>';
					 
						 for (let i = 0; i < ItemArray.length; i++) 
						 {     
							  html += '<option value="'+ItemArray[i].name+'" data-id="'+ItemArray[i].id+'">'+ItemArray[i].name+'</option>';
							  html_1 += '<option value="'+ItemArray[i].name+'" data-id="'+ItemArray[i].id+'">'+ItemArray[i].name+'</option>';

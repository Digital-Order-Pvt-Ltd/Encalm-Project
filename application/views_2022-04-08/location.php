...
<section class="video-position">
   <img src="<?=base_url()?>assets/image/inter-header.jpg" alt="encalm" width="100%;"/>
</section>
        ...
        <div class="col-lg-10 pt-4 pt-lg-0 content">
              ...
              <div class="row">
                <div class="col-lg-4">
                  <div class="box-center">
                    <img class="box-image" src="<?=base_url()?>assets/image/logo/encalm-lounge.jpg" alt="Encalm"/>
                  </div>
                </div>
                <div class="col-lg-8">
                    ...
                    <p class="color-black mails"><a href="mailto:t1d.lounge@encalm.com"><i class="fa fa-envelope color-blue" aria-hidden="true"></i> t1d.lounge@encalm.com</a> <a href="tel:+911149654282"><i class="fa fa-phone color-blue" aria-hidden="true"></i> +91 1149654282</a></p>
          ...
          <div class="box-location">
              <div class="row">
                <div class="col-lg-4">
                    <div class="box-center">
                    <img class="box-image" src="<?=base_url()?>assets/image/logo/atithya-location.jpg" alt="Encalm"/>
                  </div>
                </div>
                <div class="col-lg-8">
                    <h3 class="color-main f-28">Atithya</h3>
                    <h5 class="color-blue f-22"><i class="fa fa-map-marker" aria-hidden="true"></i> T1/T2/T3, IGI Airport, New Delhi -110037</h5>

      ...
      <div class="row">
        <div class="col-lg-12  pt-lg-0 content">
          <div class="section-title text-center">
            <!--<h2>About</h2>-->
            <p class="mr-top-136"><img src="<?=base_url()?>assets/image/atithya/Atithya-Logo-Golden.jpg" alt="Lounge Service" title="Lounge Service" style="width: 150px;"></p>
          </div>
    <!--           <div class="row">-->
    <!--  <div class="col-lg-12">-->
    <!--    <div class="section-title text-center">-->
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="border-left">
                  ...
                  <p class="text-center color-black"><i class="fa fa-phone color-blue" aria-hidden="true"></i><a class="color-black" href="tel:+919289366950"> +91-9289366950</a></p>
              </div>
          </div>
          <div class="col-lg-6">

...
.single-logo img{padding:0px 15px!important;}
  ...
  .section-padding{
    ...
    p.rate{background: #000000!important; padding: 8px 15px; color:#ffffff!important; text-align: center;}
    .ful{padding:15px;}
    .ful .wid-50{width: 50%;
    text-align: center;
    float: left;
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-5">
            <div class="row">
              ...
              <form id="homeform" action="" method="post">
                  <div class="blacks-box">
                      <p class="rate mb-0">Make Your Reservation</p>
                      <div class="ful">
                        ...
                        <select name="site" id ="homebook" class="form-control mar-bt-15">
                           ...
                           <option value="<?=base_url()?>atithya"><img src="<?=base_url()?>assets/image/Atithya-Logo-Golden.png" alt="Atithya" title="Atithya" style="width: 30px;"> Atithya</option>
                        </select>
            ...
            <div class="row">
              <div class="col-lg-12 m-auto text-center text-white py-4">
                <h1 class="post-bottom delightful">Creating Delightful Experiences </h1>
            ...
            <div class="flip-card">
              <div class="flip-card-inner">
                ...
                <div class="flip-card-back">
                  ...
                  <a href="<?=base_url()?>services/encalm_lounge" class="cus-btn">Read  More <i class="bi bi-arrow-right-circle"></i></a><br>&nbsp;
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="flip-card">
              <div class="flip-card-inner">
                ...
                <div class="flip-card-back">
                  ...
                  <a href="<?=base_url()?>services/encalm_atithya" class="cus-btn">Read More <i class="bi bi-arrow-right-circle"></i></a><br>&nbsp;
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="flip-card">
              <div class="flip-card-inner">
                ...
                <div class="flip-card-back">
                  ...
                  <a href="<?=base_url()?>" class="cus-btn">Read More <i class="bi bi-arrow-right-circle"></i></a><br>&nbsp;
                </div>
              </div>
            </div>
          </div>

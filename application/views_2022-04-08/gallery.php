    ...
    <div class="container">
      ...
      <div class="row ml-0 mr-0  mb-5">
            ...
            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                <a href="<?=base_url()?>assets/image/gallery/Atithya.jpg" class="fancybox" rel="ligthbox">
                    <img src="<?=base_url()?>assets/image/gallery/Atithya.jpg" class="zoom img-fluid"  alt="Encalm">
                   
                </a>
                <div class="share-icon">
                    <p><span><a href="#"><i class="fa fa-share-alt" aria-hidden="true"></i></a> </span> <!----<a herf="#"><i class="fa fa-facebook-square" aria-hidden="true"></i></a> <a herf="#"><i class="fa fa-twitter-square" aria-hidden="true"></i></a> <a herf="#"><i class="fa fa-instagram" aria-hidden="true"></i></a> <a herf="#"><i class="fa fa-linkedin-square" aria-hidden="true"></i></a> <a herf="#"><i class="fa fa-pinterest-square" aria-hidden="true"></i></a>------></p>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                <a href="<?=base_url()?>assets/image/gallery/Lounge-1.jpg" class="fancybox" rel="ligthbox">
                    <img src="<?=base_url()?>assets/image/gallery/Lounge-1.jpg" class="zoom img-fluid"  alt="Encalm">
            ...
            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                <a href="<?=base_url()?>assets/image/gallery/Lounge-2.jpg" class="fancybox" rel="ligthbox">
                    <img src="<?=base_url()?>assets/image/gallery/Lounge-2.jpg" class="zoom img-fluid"  alt="Encalm">
            ...
            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                <a href="<?=base_url()?>assets/image/gallery/Lounge-3.jpg" class="fancybox" rel="ligthbox">
                    <img src="<?=base_url()?>assets/image/gallery/Lounge-3.jpg" class="zoom img-fluid"  alt="Encalm">
             ...
             <div class="col-lg-3 col-md-4 col-xs-6 thumb">
               <a href="<?=base_url()?>assets/image/gallery/Lounge.jpg" class="fancybox" rel="ligthbox">
                    <img src="<?=base_url()?>assets/image/gallery/Lounge.jpg" class="zoom img-fluid"  alt="Encalm">

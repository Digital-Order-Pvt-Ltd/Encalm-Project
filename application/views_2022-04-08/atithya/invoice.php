...
<? //p(json_decode($datalist));?>
	...
	<form action="<?=base_url('atithya/user/invoice/'.$mainData->datalist[0]->itinerary_no.'/'.$param);?>"  method="post"><input type="submit" name="pdf" value="Generate Pdf"> </form>
        <table width="100%" cellspacing="0" cellpadding="0">
            <tr>
                <td style="padding: 10px 10px;"><img src="<?=base_url('atithya/invoice/')?>assets/images/logowhite.png" width="" height="100"></td>
                <td style="padding: 10px 10px; text-align: right;"><img src="<?=base_url('atithya/invoice/')?>assets/images/atithyalogo.png" width="" height="100"></td>
            </tr>
        </table>
    </div>
    <div style="content">
                ...
                <tr>
                    <td>
                        <table style="font-size: 13px; width: 100%; border-collapse: collapse; margin: 0px 0px;" width="100%" cellpadding="0" cellspacing="0">
                            <tbody>
                                <tr>
                                    <td style="padding: 8px 8px; border: solid 1px #cda45e; border-top: solid 0px #cda45e; border-collapse: collapse; background: #cda45e; color: #ffffff;">Name to be displayed on Placard : <?php echo !empty($mainData->datalist[0]->title[1])?$mainData->datalist[0]->title[1]:'NA'; ?> <?php echo !empty($mainData->datalist[0]->first_name)?$mainData->datalist[0]->first_name:'NA'; ?> <?php echo !empty($mainData->datalist[0]->last_name)?$mainData->datalist[0]->last_name:'NA'; ?></td>

...
<!-- Favicons -->
<link href="<?=base_url('atithya/')?>assets/img/favicon.png" rel="icon">
<link href="<?=base_url('atithya/')?>assets/img/apple-touch-icon.png" rel="apple-touch-icon">

<!-- Google Fonts -->
<link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600;1,700|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">

<!-- Vendor CSS Files -->
<link href="<?=base_url('atithya/')?>assets/vendor/animate.css/animate.min.css" rel="stylesheet">
<link href="<?=base_url('atithya/')?>assets/css/all.min.css" rel="stylesheet">
<link href="<?=base_url('atithya/')?>assets/vendor/aos/aos.css" rel="stylesheet">
<link href="<?=base_url('atithya/')?>assets/vendor/bootstrap/css/bootstrap.css" rel="stylesheet">
<link href="<?=base_url('atithya/')?>assets/vendor/bootstrap-datetimepicker/daterangepicker.css" rel="stylesheet">
<link href="<?=base_url('atithya/')?>assets/vendor/bootstrap-datetimepicker/bootstrap-datetimepicker.css" rel="stylesheet">
<link href="<?=base_url('atithya/')?>assets/vendor/bootstrap-icons/bootstrap-icons.css" rel="stylesheet">
<link href="<?=base_url('atithya/')?>assets/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
<link href="<?=base_url('atithya/')?>assets/vendor/glightbox/css/glightbox.min.css" rel="stylesheet">
<link href="<?=base_url('atithya/')?>assets/vendor/swiper/swiper-bundle.min.css" rel="stylesheet">
<link href="<?=base_url('atithya/')?>assets/vendor/select2/css/core.css" rel="stylesheet">

<!-- Template Main CSS File -->
<link href="<?=base_url('atithya/')?>assets/css/style.css" rel="stylesheet">
</head>
...
<header id="header" class="fixed-top d-flex align-items-cente">
  <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
    <h1 class="logo me-auto me-lg-0"><a href="index.php" class="logo me-auto me-lg-0"><img src="<?=base_url('atithya/')?>assets/img/logo.png" alt="" class="img-fluid"></a></h1>
    ...
    <div class="row d-flex align-items-center">
      ...
      <div class="col-lg-6 bg-white rounded-3 p-0 search-box">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          ...
          <li class="nav-item"> <a class="nav-link" id="departure-tab" data-toggle="tab" href="#departure" role="tab" aria-controls="departure" aria-selected="false"><i class="fas fa-plane-departure"></i>&nbsp;Departure</a> </li>
          <li class="nav-item"> <a class="nav-link" id="transit-tab" data-toggle="tab" href="#transit" role="tab" aria-controls="transit" aria-selected="false"><i class="fas fa-sync-alt"></i>&nbsp;Transit</a> </li>
          <li class="nav-item"> <a class="nav-link" id="lounge-tab" data-toggle="tab" href="#lounge" role="tab" aria-controls="lounge" aria-selected="false"><i class="fas fa-couch"></i>&nbsp;Lounge</a> </li>
        </ul>
        <div class="tab-content py-4 px-5" id="myTabContent">
          <div class="tab-pane fade show active" id="arrival" role="tabpanel" aria-labelledby="arrival-tab">
            <?php include 'arrival_1.php';?>
          </div>
...
<!-- Vendor JS Files --> 
<script src="<?=base_url('atithya/')?>assets/js/jquery-2.2.4.min.js"></script> 

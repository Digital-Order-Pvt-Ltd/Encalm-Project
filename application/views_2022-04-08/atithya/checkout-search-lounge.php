			 ...
			 <div class="row d-flex align-items-center mb-3 justify-content-end">
				...
				<div class="form-group col-md-3 pd-10">
				  ...
				  <select id="lounge_gender" name="lounge_gender" class="form-control">
					...
					<option value="other" <?php if(!empty($this->session->userdata("s_customer_data")['gender']) and ($this->session->userdata("s_customer_data")['gender']=='other')) echo 'selected'; ?>>Other</option>
				  </select>
				</div>
				<div class="form-group col-md-3 pd-10">

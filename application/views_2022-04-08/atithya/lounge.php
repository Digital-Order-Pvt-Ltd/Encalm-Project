<form id="loungeForm" name="loungeForm" method="post" action="<?=base_url('atithya/home/search');?>" class="custom-search-from formfloats" enctype="application/x-www-form-urlencoded" style="min-height: 395px;">
...
<input type="hidden" name="departure_term" id="l_departure_term" value="" />
 ...
 <input type="hidden" name="airport_location_code_id" id="l_airport_location_code_id" value="0" />
	  ...
	  <input type="hidden" name="TerminalId" id="TerminalId" value="0" />
  ...
  <div class="row">
	...
	<div class="form-group col-md-6">
	  ...
	  <span class="caret"></span>
      <select id="LoungeTerminal" name="TerminalName" class="form-control"  Onchange="changeTerminal(this.value)">
        <option value=""  data-id="0"  data-code=""  data-value="">Select Terminal</option>
      </select>
    </div>
    ...
    <div class="form-group col-md-6 LoungeFlight">
    ...
    <div class="form-group col-md-4 d-none">
      <i class="far fa-clock"></i>
      <input type="text" id="LoungeServiceTimeId" name="ServiceTime" class="form-control time" maxlength="10" autocomplete="off" placeholder="" readonly style="background:lightgray" />
...
function changeTerminal(val)
{
	...
	var code = $('#LoungeTerminal').find(':selected').attr("data-code");
	var id = $('#LoungeTerminal').find(':selected').attr("data-id");
	$('#TerminalId').val(id);	
...
function getLoungeData_1(val)
{
	...
	$('#LoungeTerminal').html('');		
	$('#LoungeTerminal').html('<option value="" data-id="0" data-value="" data-code="">Select Terminal</option>');
			...
			//	 alert(item.message);
				 if(item.message=='data found.' && item.status==true)
				 {
					 const ItemArray=item.datalist;
					   var html='<option value="" data-id="0" data-value="" data-code="">Select Terminal</option>';

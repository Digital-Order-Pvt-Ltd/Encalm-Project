			...
			<?php }?>
              ...
              <div class="row">
                ...
                <!--<i class="bx bxs-hand-right" aria-hidden="true"></i> <div class="col-md-6 text-center">
                  <a href="#" class="mt-3"><img src="<?=base_url('atithya/assets/')?>img/facebook.png" alt="login with Facebook" width="300px"/></a><br/>
                  <a href="#" class="mt-3"><img src="<?=base_url('atithya/assets/')?>img/google.png" alt="login with Google" width="300px"/></a>
                  <br/>
                  <br/>

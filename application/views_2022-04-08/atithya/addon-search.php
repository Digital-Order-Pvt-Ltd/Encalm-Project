    ...
    <div class="container">
      <div class="row">
              ...
              <div class="card">
                <div class="row">
                  ...
                  <div class="col-md-7 ps-md-0">
                    <div class="card-body ps-md-0 pe-md-1">
                      <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                            	<div class="row">
                            		<div class="col-md-8">
		                              ...
		                              <input type="number" class="form-control d-inline w-45 numberval" id="numberQty_<?=$val->id?>" name="number" min="0" max="3" placeholder="0" value="1">
									  </div>
									  <div class="col-md-4">		                              
        ...
        <div class="col-md-4 mb-4 ordersummary">
				...
				//  p($select_product_details);
				 ...
				 $NetAmountTax = array_sum(array_column($select_product_details,'ptaxprice'));
                  ...
                  <tr>
					...
					<input type="hidden" value="<?php echo $select_product_details[$i]['pqty']; ?>" class="addoncount" />
		  ...
		  <form method="post" action="<?=base_url('atithya/home/checkout')?>" onsubmit="PleaseWaitShow();">
          <button type="submit" id="submit" name="submit" class="btn btn-primary w-100"  role="button" aria-disabled="false">Continue >>></button>
		  </form>
		  <?php } else { ?>
          <a href="<?=base_url('atithya/home/confirm')?>"  class="btn btn-primary w-100" onclick="PleaseWaitShow();">Continue >></a> 
		  <?php } ?>
...
function UpdateValue(product_id,product_name,product_price,tax_price)
{
	...
	var addonqty = $('#addons_numberQty_'+product_id).val();
	
	var sum = 0;
	$('.addoncount').each(function(){
		sum += parseInt($(this).val());   
	});
	
	if((parseInt(qty)+parseInt(addonqty)) > 3)
	{
	  alert("You can max add 3 qty for each add-on products!");
	  return false;
	 }
	if(qty != "" && qty > 0)
	{

...
<? //p(json_decode($datalist));?>
    <div style="background: #152248; color: #ffffff;">
        ...
        <table width="100%" cellspacing="0" cellpadding="0">
            <tr>
                <td style="padding: 8px 8px;"><img src="<?=base_url('atithya/invoice/')?>assets/images/logowhite.png" width="" height="100"></td>
                <td style="padding: 8px 8px; text-align: right;"><img src="<?=base_url('atithya/invoice/')?>assets/images/atithyalogo.png" width="" height="100"></td>
            </tr>
        </table>
    </div>
    <div style="content">

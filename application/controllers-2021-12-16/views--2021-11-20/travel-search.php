                ...
                <div class="card-body ps-0">
                  ...
                  <div class="row mt-2">
                    <div class="col-md-12">
					  ...
					  <a onclick='redirecturl("<?=base_url("home/addons/".$val->id)?>",<?=$val->id?>,"<?=$val->name?>","<?=!empty($val->list_price)?$val->list_price:0?>")' class="btn btn-primary float-end btn-sm small">Select</a> <a href="javascript:void(0)" class="morebtn small">More...</a>

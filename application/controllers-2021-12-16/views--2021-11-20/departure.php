  ...
  <div class="row">
    ...
    <div class="form-group col-md-6">
      ...
      <select id="" name="" class="form-control" size="1">
        ...
        <option value="DXB" data-id="DXB">Dubai International Airport</option>
        <option value="DWC" data-id="DWC">Al Maktoum International Airport</option>
        <option value="ADL" data-id="ADL">Adelaide International Airport</option>

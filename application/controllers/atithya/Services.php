...
class Services extends CI_Controller {
 public function __construct() {
	...
	public function departure_new() 
	{
		...
		$this->load->view('atithya/services_departure_new');
	}
	public function arrival_new() 
	{
		//p($this->session->all_userdata()); 
		  $s_category = !empty($this->session->userdata("s_category"))?$this->session->userdata("s_category"):'';
			if(!empty($s_category))
		...
		$this->load->view('atithya/services_arrival_new');
	}
	...
	public function arrival() 
	{
		...
		$this->load->view('atithya/services_arrival');
	}
	...
	public function departure() 
	{
		...
		$this->load->view('atithya/services_departure');
	}
	public function transit_new() 
	{
		//p($this->session->all_userdata()); 
		  $s_category = !empty($this->session->userdata("s_category"))?$this->session->userdata("s_category"):'';
			if(!empty($s_category))
		...
		$this->load->view('atithya/services_transit_new');
	}
	public function transit() 
	{
		...
		$this->load->view('atithya/services_transit');
	}
	...
	public function lounge() 
	{
		...
		$this->load->view('atithya/services_lounge');
	}

			...
			<?php }?>
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <a class="text-dark" href="#">  <i class="text-warning bx bxs-info-circle" ></i> Forgot Password</a> 
                  <hr/>
                  <p class="text-dark"> 
                    <a class="text-primary" href="#"> <i class="bx bxs-hand-right" aria-hidden="true"></i> Create Your Account </a>
                  </p>
                </div>
                <div class="col-md-6 text-center">
                  <a href="#" class="mt-3"><img src="<?=base_url('assets/')?>img/facebook.png" alt="login with Facebook" width="300px"/></a><br/>
                  <a href="#" class="mt-3"><img src="<?=base_url('assets/')?>img/google.png" alt="login with Google" width="300px"/></a>
                  <br/>
                  <br/>
                  <a class="text-primary" href="#"> <i class="text-warning bx bxs-info-circle" ></i> Forgot Password</a> |  <a class="text-primary" href="#"> Sign Up </a> 
                </div>
            </div>
        </div>
      </div>

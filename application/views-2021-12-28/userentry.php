...
<?php for($i=1;$i<=$this->session->userdata('s_adult');$i++){ ?>
  <div class="row d-flex align-items-center mb-3 justify-content-end" id="s_adult_<?php echo $i; ?>">
     
	  <input type="hidden" class="form-control parent_id"  name="adult_id[]" value="0" id="adult_id_<?=$i?>" />
    <div class="form-group col-md-1 pe-0"><span class="btn-secondary text-center w-100  d-inline-block small" style="line-height: 44px">Adult <?=$i?></span></div>
    ...
    <div class="col-md-3">
        <div class="row">
            <div class="form-group col-md-6 pd-10">
              <input type="text" class="form-control first_name" id="adult_first_name_<?=$i?>" name="adult_first_name[]" placeholder="">
              <label for="" class="floating-label">First Name*</label>
            </div>
            <div class="form-group col-md-6 pd-10">
              <input type="text" class="form-control last_name" id="adult_last_name_<?=$i?>" name="adult_last_name[]" placeholder="">
	...
	<div class="form-group col-md-1 pd-10">
	  ...
	  <span class="caret"></span>
	  <select id="adult_gender_<?=$i?>" name="adult_gender[]" class="form-control gender">
	...
	<div class="form-group col-md-1 pd-10">
      <input type="text" class="form-control age" id="adult_age_<?=$i?>" name="adult_age[]" placeholder="">
      <label for="" class="floating-label">Age*</label>
    </div>
    <div class="form-group col-md-2 pd-10">
      <input type="text" class="form-control passport" id="adult_passport_<?=$i?>" name="adult_passport[]" placeholder="">
    ...
    <div class="form-group col-md-1 pd-10">
      <input type="text" class="form-control pnr" id="adult_pnr_<?=$i?>" name="adult_pnr[]" placeholder="">
...
<?php if(!empty($this->session->userdata('s_child'))){ for($i=1;$i<=$this->session->userdata('s_child');$i++){ ?>
  <div class="row d-flex align-items-center mb-3 justify-content-end" id="s_child_<?php echo $i; ?>">
    <div class="form-group col-md-1 pe-0"><span class="btn-secondary text-center w-100 d-inline-block small" style="line-height: 44px">Child <?=$i?></span></div>
	
	<input type="hidden" class="form-control parent_id"  name="child_id[]" value="0" id="child_id_<?=$i?>" />
    <div class="form-group col-md-1 pd-10">
      <label for="" class="d-none">Title*</label>
      <span class="caret"></span>
      ...
      <div class="col-md-3">
        <div class="row">
            <div class="form-group col-md-6 pd-10">
              <input type="text" class="form-control first_name" id="child_first_name_<?=$i?>" name="child_first_name[]" placeholder="">
              <label for="" class="floating-label">First Name*</label>
            </div>
            <div class="form-group col-md-6 pd-10">
              <input type="text" class="form-control last_name" id="child_last_name_<?=$i?>" name="child_last_name[]" placeholder="">
              <label for="" class="floating-label">Last Name*</label>
            </div>
      </div>
</div>
    ...
    <div class="form-group col-md-1 pd-10">
      <input type="text" class="form-control age" id="child_age_<?=$i?>" name="child_age[]" placeholder="">
      <label for="" class="floating-label">Age*</label>
    </div>
    <div class="form-group col-md-2 pd-10">
      <input type="text" class="form-control passport" id="child_passport_<?=$i?>" name="child_passport[]" placeholder="">
      <label for="" class="floating-label">Passport/Govt Id</label>
    </div>
	<div class="form-group col-md-2 pd-10">
      <label for="" class="d-none">Travel Class*</label>
	  <span class="caret"></span>
	  <select id="child_class_<?=$i?>" name="child_class[]" class="form-control">
         <option value="">Travel Class*</option>
        <option value="business">Business</option>
        <option value="economy">Economy</option>
      </select>
    ...
    <div class="form-group col-md-1 pd-10">
      <input type="text" class="form-control pnr" id="child_pnr_<?=$i?>" name="child_pnr[]" placeholder="">
      <label for="" class="floating-label">PNR No.*</label>
    </div>
    <div class=clearfix></div>
  </div>
  ...
  <div class="row d-flex align-items-center mb-3 justify-content-end" id="s_infant_<?php echo $i; ?>">
    <div class="form-group col-md-1 pe-0"><span class="btn-secondary text-center w-100 d-inline-block small" style="line-height: 44px">Infant <?=$i?></span></div>
	<input type="hidden" class="form-control parent_id"  name="infant_id[]" value="0" id="infant_id_<?=$i?>" />
    <div class="form-group col-md-1 pd-10">
      <label for="" class="d-none">Title*</label>
      <span class="caret"></span>
     ...
     <div class="col-md-3">    
          <div class="row">
              <div class="form-group col-md-6 pd-10">
                <input type="text" class="form-control first_name" id="infant_first_name_<?=$i?>" name="infant_first_name[]" placeholder="">
                <label for="" class="floating-label">First Name*</label>
              </div>
              <div class="form-group col-md-6 pd-10">
                <input type="text" class="form-control last_name" id="infant_last_name_<?=$i?>" name="infant_last_name[]" placeholder="">
                <label for="" class="floating-label">Last Name*</label>
              </div>
            </div>
          </div>
    ...
    <div class="form-group col-md-1 pd-10">
      <input type="text" class="form-control age" id="infant_age_<?=$i?>" name="infant_age[]" placeholder="">
      <label for="" class="floating-label">Age</label>
    </div>
    <div class="form-group col-md-2 pd-10">
      <input type="text" class="form-control passport" id="infant_passport_<?=$i?>" name="infant_passport[]" placeholder="">
      <label for="" class="floating-label">Passport/Govt Id</label>
    </div>
	<div class="form-group col-md-2 pd-10">
      <label for="" class="d-none">Travel Class*</label>
	  <span class="caret"></span>
	  <select id="infant_class_<?=$i?>" name="infant_class[]" class="form-control">
	     <option value="">Traval Class*</option>
        <option value="business">Business</option>
        <option value="economy">Economy</option>
      </select>
	</div>
    <div class="form-group col-md-1 pd-10">
      <input type="text" class="form-control pnr" id="infant_pnr_<?=$i?>" name="infant_pnr[]" placeholder="">
      <label for="" class="floating-label">PNR No.*</label>
    </div>
    <div class=clearfix></div>
  </div>

...
<main id="hero" class="bg-white">
  <div class="bg-light pt-5">
     <div class="section-title text-center">
            ...
            <p>My Booking Details  &nbsp; &nbsp;<a style="float:right;" href="<?=base_url("user/booking_cancel/".$obid);?>" class="btn btn-danger">Cancel Booking</a> &nbsp; &nbsp; &nbsp; &nbsp;<!--a style="float:right;" href="" class="btn btn-primary">Download Invoice</a-->&nbsp;  &nbsp; &nbsp; </p>
        <?php if(!empty($this->session->flashdata('success'))) {?>
            
           <br><h3> <center><?=$this->session->flashdata('success')?></center></h3>

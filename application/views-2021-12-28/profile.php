...
<main id="hero" class="bg-white">
  ...
  <div class="row">
	...
	<div class="form-group col-md-6 pd-10">
      ...
      <input type="text" class="form-control" id="address" name="address" placeholder="Address"  value="<?=$localuserdata->address?>" />
    </div>
	
	<div class="form-group col-md-2 pd-10">
      <label class="d-none">City</label>
      <input type="text" class="form-control" id="city" name="city" placeholder="City"  value="<?=$localuserdata->city?>" />
    </div>
	<div class="form-group col-md-2 pd-10">
	...
	<div class="form-group col-md-2 pd-10 pd-10 onlydigit">
      ...
      <input type="text" class="form-control digitvalidate" id="pincode" name="pincode" placeholder="Pincode"  value="<?=$localuserdata->pincode?>" />
    </div>
    <div class="col-md-5">
    <div class="row">
    ...
    <div class="form-group col-md-9 col-xs-9 pd-10 onlydigit">
      ...
      <input type="text" class="form-control digitvalidate" id="mobile" name="mobile" placeholder="Mobile"  value="<?=$localuserdata->mobile?>" / >
    </div>
  </div>
</div>
    <div class="form-group col-md-3 pd-10">

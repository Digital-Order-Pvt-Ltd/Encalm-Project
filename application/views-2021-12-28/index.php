    ...
    <div class="row d-flex align-items-center">
      ...
      <div class="col-lg-6 bg-white rounded-3 p-0 search-box">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          ...
          <li class="nav-item"> <a class="nav-link check-class" id="transit-tab" data-toggle="tab" href="#transit" role="tab" aria-controls="transit" aria-selected="false"  onclick="HomeActiveTab('Transit')" ><img src="<?=base_url('assets/')?>img/transit-01.png">&nbsp;Transit</a> </li>
...
<script>
  ...
  $(document).ready(function(){
    $('.check-class').click(function(){
        ...
        {
            $(this).html('<img src="<?=base_url('assets/')?>img/transit-02.png" width="24px"/>&nbsp;Transit');
        }
        else
        {
          $(this).html('<img src="<?=base_url('assets/')?>img/transit-01.png" width="24px"/>&nbsp;Transit');
        }
    });
    $(".check-class-2").click(function(){
        $(".check-class").html('<img src="<?=base_url('assets/')?>img/transit-01.png" width="24px"/>&nbsp;Transit');
    });
  });
</script>
</body>

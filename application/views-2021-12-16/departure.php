<form id="departureForm" name="departureForm" method="post"  action="<?=base_url('home/search');?>" class="custom-search-from formfloats" enctype="application/x-www-form-urlencoded" style="min-height: 395px;">
...
<input type="hidden" name="departure_term" id="d_departure_term" value="" />
  ...
  <div class="row">
    ...
    <div class="form-group col-md-4">
      <i class="far fa-clock"></i>
        <input type="text" id="DepartureServiceTimeId" name="DepartureServiceTime" class="form-control time" maxlength="10" autocomplete="off" placeholder=""   readonly style="background:lightgray" />
    ...
    <div class="form-group col-lg-12 text-center">
      <button type="submit" id="departureFormSubmit" name="departureFormSubmit" class="btn btn-red"  role="button" aria-disabled="false">Search</button>
    </div>
    <div class=clearfix></div>
   ...
   $('#Departuredod').val('');
	...
	$.ajax({
			...
			//	 alert(item.message);
				 ...
				 {
					 const ItemArray=item.datalist;
					   var html='<option value="" data-id="0">Select Departing To</option>';

  ...
  <section class="mamber-card-checkout">
    <div class="container search-box">
	  ...
	  <div class="section-title">
            <p>My Booking Details  &nbsp; &nbsp;<!--a style="float:right;" href="" class="btn btn-danger">Cancel Booking</a> &nbsp; &nbsp; &nbsp; &nbsp;<a style="float:right;" href="" class="btn btn-primary">Download Invoice</a-->&nbsp;  &nbsp; &nbsp; </p>

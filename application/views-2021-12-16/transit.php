<form id="transitForm" name="transitForm" method="post" action="<?=base_url('home/search');?>" class="custom-search-from formfloats" enctype="application/x-www-form-urlencoded" style="min-height: 395px;">
...
<input type="hidden" name="terminal_value" id="tad_terminal_value" value="" />
  ...
  <div class="row">
    ...
    <div class="form-group col-md-6 TransitToAirtport">
      ...
      <!--span class="caret"></span-->
	   <select id="TransitToAirtport" name="TransitToAirtport" class="form-control select2-single" size="1" Onchange="getDeparting_3(this.value)">
        <option value=""  data-id="0">Select Departing To</option>
      </select>
    ...
    <div class="form-group col-md-4">
	  ...
	  <input type="text" id="TransitArrivalServiceTimeId"  name="TransitArrivalServiceTime" class="form-control time" maxlength="10" autocomplete="off" placeholder="" style="background:lightgray" readonly  value=""   />
    ...
    <div class="form-group col-md-4">
      ...
      <label for="" class="floating-label">Departure Time*</label>
    </div>
...
function getAirportData_2(val)
{
	...
	$("#TransitToAirtport").html('<option value="" data-id="0">Select Departing To</option>');
			...
			//	 alert(item.message);
				 if(item.message=='data found.' && item.status==true)
				 {
					 const ItemArray=item.datalist;
					   ...
					   var html_1='<option value="" data-id="0">Select Departing To</option>';

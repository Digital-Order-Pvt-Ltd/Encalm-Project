<form id="arrivalForm" name="arrivalForm" method="post" action="<?=base_url('home/search');?>" class="custom-search-from" enctype="application/x-www-form-urlencoded" style="min-height: 395px;">
  ...
  <div class="row">
    ...
    <div class="form-group col-md-6">
	  ...
	  <select id="AStartFromAirport" name="FromAirport" class="form-control" size="1"  Onchange="getDeparting(this.value)">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" id="Arrivaldof" name="doa" class="form-control datepicker" placeholder="Date of Arrival" onchange="getArrivalFlightList(this.value)" value="" />
    </div>
    ...
    <div class="form-group col-md-4">
      ...
      <input type="text" id="ArrivalTimeId"  name="ArrivalTime" class="form-control time" maxlength="10" autocomplete="off" placeholder="Arrival Time*" onfocus="this.type='time'"  value="" onchange="getArrivalTime(this.value)">
    </div>
    <div class="form-group col-md-4">
      <label for="" class="d-none">Service Time*</label>
      <i class="far fa-clock"></i>
      <input type="text" id="ArrivalServiceTimeId" name="ServiceTime" class="form-control time" maxlength="10" autocomplete="off" placeholder="Service Time*" onfocus="this.type='time'" readonly style="background:lightgray" />
    </div>
...
function getAirportData(val)
{
	...
	$("#AStartFromAirport").html('<option value="" data-id="0">Select Departing From</option>');

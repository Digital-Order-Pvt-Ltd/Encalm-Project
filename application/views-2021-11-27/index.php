    ...
    <div class="row d-flex align-items-center">
      ...
      <div class="col-lg-6 bg-white rounded-3 p-0 search-box">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          ...
          <li class="nav-item"> <a class="nav-link" id="transit-tab" data-toggle="tab" href="#transit" role="tab" aria-controls="transit" aria-selected="false"  onclick="HomeActiveTab('Departure')" ><i class="fas fa-sync-alt"></i>&nbsp;Transit</a> </li>
          <li class="nav-item"> <a class="nav-link" id="lounge-tab" data-toggle="tab" href="#lounge" role="tab" aria-controls="lounge" aria-selected="false"  onclick="HomeActiveTab('Departure')"><i class="fas fa-couch"></i>&nbsp;Lounge</a> </li>
        </ul>
				...
				const item=data;
				 ...
				 if(item.message=='data found.' && item.status==true)
				 {
					 const ItemArray=item.datalist;
					 	 ...
					 	 var html='<option value="" selected="selected">From Airport</option>';
				...
				const item=data;
				 ...
				 if(item.message=='data found.' && item.status==true)
				 {
					 ...
					 var html='<option value="" selected="selected">Flight No.*</option>';
						 ...
						 for (let i = 0; i < ItemArray.length; i++) 
						 {
							   html += '<option value="'+ItemArray[i].flight_name+'" data-id="'+ItemArray[i].id+'"  data-name="'+ItemArray[i].arrival_time+'">'+ItemArray[i].flight_name+'</option>';
						 }
 ...
 function getFlightArrivalTime()
{
	...
	var date = $('#ArrivalFlight').find(':selected').attr('data-name');
